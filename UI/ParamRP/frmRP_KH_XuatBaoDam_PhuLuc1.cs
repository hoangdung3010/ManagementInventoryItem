...
namespace FormUI
{
    public partial class frmRP_KH_XuatBaoDam_PhuLuc1 : MXTraForm
    {
        #region"Declare"
        #endregion
        #region"Contructor"
        public frmRP_KH_XuatBaoDam_PhuLuc1()
        {
            InitializeComponent();
            mUserControlParamRP.RootControl = groupBoxInput;
            mUserControlParamRP.ConfigReport = new MT.Data.BO.ConfigReport
            {
                RepName= "KH_XuatBaoDam_PhuLuc1Repository",
                DictionaryKey= MT.Data.ReportDictionaryKey.RP_KH_XuatBaoDam_PhuLuc1,
                ShowColumnsOrder=new HashSet<string>
                {
                    "sSTT","sDanhMuc","sTenDonViTinh","TongCong","QD","CA",
                    "DC","HV","NG","KhoMBTongCong","KhoMBCA","KhoMBQD",
                    "KhoMBDC","KhoMBNG","KhoMBHV","KhoMNTongCong","KhoMNCA","KhoMNQD",
                    "KhoMNDC","KhoMTTongCong","KhoMTQD","KhoMTDC"
                }
            };
        ...
        #region"Event"
        private void frmRP_KH_XuatBaoDam_PhuLuc1_Load(object sender, EventArgs e)
        {
            Init();
        }
        #endregion
