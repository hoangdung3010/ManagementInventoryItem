...
namespace FormUI
{
    public partial class frmDM_DonViTinh : FormUI.MFormList
    {
        #region"Property"
        #endregion
        ...
        public frmDM_DonViTinh()
        {
            ...
            ConfigFormDetail = new ConfigFormDetail
            {
                ...
                FormName = "frmDM_DonViTinhDetail",
                Grid= gridMaster,
        ...
        private void InitGrid()
        {
           var grd= this.gridMaster.GetMGridControl();
            ...
            this.gridMaster.AddColumnText("sTenDonViTinh", "Tên đơn vị tính", 200);
