...
namespace FormUI
{
    public partial class frmDM_NoiDungSuaChua : FormUI.MFormList
    {
        #region"Property"
        #endregion

        #region"Contructor"
        public frmDM_NoiDungSuaChua()
        {
            InitializeComponent();
            ...
            ConfigFormDetail = new ConfigFormDetail
            {
                ...
                FormName = "frmDM_NoiDungSuaChuaDetail",
                Grid= gridNDSC,
