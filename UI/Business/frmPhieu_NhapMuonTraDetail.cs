...
namespace FormUI
{
    public partial class frmPhieu_NhapMuonTraDetail : FormUI.MFormBusinessDetail
    {
        private DM_DonViRepository dM_DonViRepository;

        public frmPhieu_NhapMuonTraDetail()
        {
            InitializeComponent();
            ...
            if (ConfigFormDetail == null)
            {
                ...
                {
                    Rep = DBContext.GetRep<Phieu_NhapMuonTraRepository>(),
            ...
            {
                {"Phieu_NhapMuonTra_CT",grdSanPham }
            };
        ...
        private void InitLookup()
        {
            ...
            // Phieu xuat
            //cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DisplayMember = "sMa";
            //cbossPhieu_XuatMuonTra_Id_CanCu.Properties.ValueMember = "Id";
            //cbossPhieu_XuatMuonTra_Id_CanCu.AddColumn("sMa", "Số phiếu xuất", 180, true);
            //cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_XuatMuonTraRepository>().GetData(typeof(MT.Data.BO.Phieu_XuatMuonTra),
            //    columns: "Id,sMa", orderBy: "sMa");
            cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DisplayMember = "sMa";
            cbossPhieu_XuatMuonTra_Id_CanCu.Properties.ValueMember = "Id";
            cbossPhieu_XuatMuonTra_Id_CanCu.AddColumn("sMa", "Số phiếu xuất", 120);
            cbossPhieu_XuatMuonTra_Id_CanCu.AddColumn("dNgayPhieu_Xuat", "Ngày lập", 80);
            cbossPhieu_XuatMuonTra_Id_CanCu.AddColumn("sDM_DonVi_Id_Xuat_Ten", "Đơn vị lập", 120);
            ...
            cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_XuatMuonTraRepository>().GetData(typeof(MT.Data.BO.Phieu_XuatMuonTra),
                ...
                orderBy: "sSo DESC",
                viewName: "View_Phieu_XuatMuonTra",
            ...
            linkFormVoucher.ControlVoucher = cbossPhieu_XuatMuonTra_Id_CanCu;
            linkFormVoucher.TableName = "Phieu_XuatMuonTra";

            cboEnumiLoaiTCNhap.EnumData = "iTCNhap";
        }
        ...
        private void InitGrid()
        {
            ...
            //Sản phẩm
            grdSanPham.GrdDetail.TableName = "Phieu_NhapMuonTra_CT";
            grdSanPham.GrdDetail.ViewName = "View_Phieu_NhapMuonTra_CT";
            grdSanPham.GrdDetail.KeyName = "Id";
            grdSanPham.GrdDetail.SetField = "phieu_NhapMuonTra_CTs";
            ...
            col = grdSanPham.GrdDetail.AddColumnText("sPhieu_XuatMuonTra_CT_Id", "sPhieu_XuatMuonTra_CT_Id", 0);
            col.Visible = false;
        }
        ...
        private bool grdSanPham_ColsMaVach_CustomEventEnter(MRepositoryTextEdit mRepositoryTextEdit, MTextEdit mTextEdit)
        {
            try
            {
                if (mTextEdit.EditValue != null)
                {
                    ...
                    //List<MT.Data.BO.Phieu_NhapMuonTra_CT> phieu_NhapMuonTra_CTs = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapMuonTra_CT>();
                    // Truong Added 14.6:
                    List<MT.Data.BO.Phieu_NhapMuonTra_CT> phieu_NhapMuonTra_CTs_current = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapMuonTra_CT>();
                    Phieu_NhapMuonTra_CT phieu_NhapMuonTra_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapMuonTra_CT>();

                    // 1. Kiểm tra nếu mã vạch đã có trên danh sách rồi thì không cho nhập, cảnh báo trùng
                    MT.Data.BO.Phieu_NhapMuonTra_CT findBysMaVach_current = phieu_NhapMuonTra_CTs_current.Find(m => m.sMaVach.Equals(sMaVach) && m.Id != phieu_NhapMuonTra_CT.Id);
                    if (findBysMaVach_current != null)
                    {
                        MMessage.ShowWarning($"Mã vạch <{sMaVach}> đã tồn tại trên danh sách");
                        return true;
                    }
                    // 2. Kiểm tra xem mã vạch đó còn tồn tại trong phiếu xuất không
                    ...
                    if (lkMaVachCTS != null)
                    {
                        phieu_NhapMuonTra_CT.sDM_ChungThuSo_Id = lkMaVachCTS.sDM_ChungThuSo_Id;
                    }
                    ...
                    if (lkMaVachMLL != null)
                    {
                        phieu_NhapMuonTra_CT.sDM_MangLienLac_Id = lkMaVachMLL.sDM_MangLienLac_Id;
                    }

                    Guid? sPhieuXuatMuonTra_Id = null;
                    if (cbossPhieu_XuatMuonTra_Id_CanCu.EditValue != null)
                        sPhieuXuatMuonTra_Id = Guid.Parse(cbossPhieu_XuatMuonTra_Id_CanCu.EditValue.ToString());

                    if (sPhieuXuatMuonTra_Id.HasValue)
                    {
                        Phieu_XuatMuonTra_CT phieu_XuatMuonTra_CT = DBContext.GetRep2<Phieu_XuatMuonTra_CTRepository>()
                                                                    .GetPhieu_XuatMuonTra_CTBysPhieu_XuatMuonTra_CT_IdAndsMaSP(sPhieuXuatMuonTra_Id, sMaVach);
                        if (phieu_XuatMuonTra_CT == null)
                        {
                            MMessage.ShowWarning($@"Phiếu xuất <{cbossPhieu_XuatMuonTra_Id_CanCu.Text}> không tồn tại sản phẩm có mã vạch <{sMaVach}>");
                            return true;
                        }

                        //Lấy chi tiết phụ kiện theo phiếu xuất
                        List<MT.Data.BO.Phieu_XuatMuonTra_CT_PhuKien> phieu_XuatMuonTra_CT_PhuKiens = DBContext.GetRep2<Phieu_XuatMuonTra_CT_PhuKienRepository>()
                                                                                                    .GetPhieu_XuatMuonTra_CT_PhuKiensBysPhieu_XuatMuonTra_CT_Id(phieu_XuatMuonTra_CT.Id);
                        List<MT.Data.BO.Phieu_NhapMuonTra_CT_PhuKien> phieu_NhapMuonTra_CT_PhuKiens = new List<Phieu_NhapMuonTra_CT_PhuKien>();
                        if (phieu_XuatMuonTra_CT_PhuKiens != null)
                        {
                            foreach (var item in phieu_XuatMuonTra_CT_PhuKiens)
                            {
                                phieu_NhapMuonTra_CT_PhuKiens.Add(new Phieu_NhapMuonTra_CT_PhuKien
                                {
                                    Id = Guid.NewGuid(),
                        ...
                        phieu_NhapMuonTra_CT.phieu_NhapMuonTra_CT_PhuKiens = phieu_NhapMuonTra_CT_PhuKiens;
                        phieu_NhapMuonTra_CT.sPhieu_XuatMuonTra_CT_Id = phieu_XuatMuonTra_CT.Id;
                        phieu_NhapMuonTra_CT.sPhieu_XuatMuonTra_Id = sPhieuXuatMuonTra_Id; // Note 14.6
                        phieu_NhapMuonTra_CT.sDM_SanPham_Id = phieu_XuatMuonTra_CT.sDM_SanPham_Id;
                        phieu_NhapMuonTra_CT.sDM_DonViTinh_Id = phieu_XuatMuonTra_CT.sDM_DonViTinh_Id;
                        phieu_NhapMuonTra_CT.rDonGia = phieu_XuatMuonTra_CT.rDonGia;
                        phieu_NhapMuonTra_CT.rThanhTien = phieu_XuatMuonTra_CT.rDonGia;
                        //phieu_NhapMuonTra_CT.sDM_MangLienLac_Id = phieu_XuatMuonTra_CT.sDM_MangLienLac_Id;
                        //phieu_NhapMuonTra_CT.sDM_MangLienLac_Id_Ten = phieu_XuatMuonTra_CT.sDM_MangLienLac_Id_Ten;
                        phieu_NhapMuonTra_CT.sDM_SanPham_Id_Ten = phieu_XuatMuonTra_CT.sDM_SanPham_Id_Ten;
                        phieu_NhapMuonTra_CT.sXuatXu = phieu_XuatMuonTra_CT.sXuatXu;
                        phieu_NhapMuonTra_CT.sCauHinhKyThuat = phieu_XuatMuonTra_CT.sCauHinhKyThuat;
                        /*phieu_NhapMuonTra_CT.iThoiGianBaoHanh = phieu_XuatMuonTra_CT.iThoiGianBaoHanh;
                        phieu_NhapMuonTra_CT.iDonViThoiGianBaoHanh = phieu_XuatMuonTra_CT.iDonViThoiGianBaoHanh;
                        phieu_NhapMuonTra_CT.iNamSX = phieu_XuatMuonTra_CT.iNamSX;
                        phieu_NhapMuonTra_CT.dHanBaoHanhDen = phieu_XuatMuonTra_CT.dHanBaoHanhDen;*/
                        phieu_NhapMuonTra_CT.sSTTSP = phieu_XuatMuonTra_CT.sSTTSP;
                        phieu_NhapMuonTra_CT.sGhiChu = phieu_XuatMuonTra_CT.sGhiChu;
                    }
                    else
                    {
                        ...
                        if (dm_SanPhams?.Count > 0)
                        {
                            ...
                            phieu_NhapMuonTra_CT.sDM_SanPham_Id = dM_SanPham.Id;
                            phieu_NhapMuonTra_CT.sDM_DonViTinh_Id = dM_SanPham.sDM_DonViTinh_Id_Cap1;
                            phieu_NhapMuonTra_CT.rDonGia = dM_SanPham.rDonGia_Cap1;
                            phieu_NhapMuonTra_CT.rThanhTien = dM_SanPham.rDonGia_Cap1;
                            phieu_NhapMuonTra_CT.sDM_SanPham_Id_Ten = dM_SanPham.sTenSanPham;
                            ...
                            phieu_NhapMuonTra_CT.sSTTSP = string.Empty;
                        }
                    }

                    phieu_NhapMuonTra_CT.IsLoaded = true;
                    phieu_NhapMuonTra_CT.rSoLuong = 1;
                    phieu_NhapMuonTra_CT.sSerial = sSerial;
                    ...
                    if (dm_Phieu_NhapSanPhamMois != null && dm_Phieu_NhapSanPhamMois.Count == 1)
                    {
                        ...
                        phieu_NhapMuonTra_CT.iThoiGianBaoHanh = curPNM.iThoiGianBaoHanh;
                        phieu_NhapMuonTra_CT.iDonViThoiGianBaoHanh = curPNM.iDonViThoiGianBaoHanh;
                        phieu_NhapMuonTra_CT.iNamSX = curPNM.iNamSX;
                        phieu_NhapMuonTra_CT.dHanBaoHanhDen = curPNM.dHanBaoHanhDen;
                    }
        ...
        private void ColsActionPhuKien_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            var phieu_NhapMuonTra_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapMuonTra_CT>();
            if (phieu_NhapMuonTra_CT.sDM_SanPham_Id.HasValue && !phieu_NhapMuonTra_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                //frmPhieu_NhapMuonTra_CT_PhuKienDetail frmPhieu_NhapMuonTra_CT_PhuKienDetail = new frmPhieu_NhapMuonTra_CT_PhuKienDetail(grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapMuonTra_CT>());
                frmPhuKienDetail frmPhuKienDetail = new frmPhuKienDetail(phieu_NhapMuonTra_CT.sDM_SanPham_Id.Value,
                    "Phieu_NhapMuonTra_CT_PhuKien", "phieu_NhapMuonTra_CT_PhuKiens", phieu_NhapMuonTra_CT, this);
        ...
        private bool grdSanPham_ValidEditValueChanging(DevExpress.XtraGrid.Columns.GridColumn gridColumn, ChangingEventArgs e)
        {
            /*if (cbossPhieu_XuatMuonTra_Id_CanCu.EditValue == null)
            {
                ActiveControl = cbossPhieu_XuatMuonTra_Id_CanCu;
            ...
            if (gridColumn.FieldName == "sSTTSP" && e.NewValue != null && !object.Equals(e.OldValue, e.NewValue))
            {
                ...
                Phieu_NhapMuonTra_CT phieu_NhapMuonTra = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapMuonTra_CT>();
                if (arrSerial.Length > 0 && (decimal)arrSerial.Length > phieu_NhapMuonTra.rSoLuong)
                {
                    e.NewValue = string.Empty;
                    MMessage.ShowWarning($"Bạn chỉ được phép chọn tối đa {(int)phieu_NhapMuonTra.rSoLuong} số serial");
                    return false;
                }
            }
        ...
        {
            Phieu_NhapMuonTra_CT phieu_NhapMuonTra_CT = (Phieu_NhapMuonTra_CT)newRecord;
            if (phieu_NhapMuonTra_CT.sDM_SanPham_Id.HasValue
                && !phieu_NhapMuonTra_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                /*if (cbossPhieu_XuatMuonTra_Id_CanCu.EditValue == null)
                {
                    ActiveControl = cbossPhieu_XuatMuonTra_Id_CanCu;
        ...
        protected override void BindingDataIntoFormSucces()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.View:
                    ...
                    ucThamChieuPhieuNhapMoi.sTenBangCanCu = "Phieu_NhapMuonTra";
        ...
        protected override void SetConfigBeforePrint(MT.Data.BO.ConfigExcel configExcel, ConfigReport configReport)
        {
            ...
            configReport.RepName = "Print_Phieu_NhapMuonTra_DetailRepository";
            //Định danh mẫu in trong bảng ReportData
            configReport.DictionaryKey = MT.Data.ReportDictionaryKey.RP_Print_Phieu_NhapMuonTraDetail;
        ...
        protected override bool IsValidateDataChangedGridDetail(MGridEditable mGridEditable, System.Collections.IList dataChanged)
        {
            ...
            {
                List<MT.Data.BO.Phieu_NhapMuonTra_CT> phieu_NhapMuonTra_CTs = mGridEditable.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapMuonTra_CT>();

                foreach (var item in dataChanged)
                {
                    var castItem = (MT.Data.BO.Phieu_NhapMuonTra_CT)item;
                    ...
                    if (isValid && phieu_NhapMuonTra_CTs != null && phieu_NhapMuonTra_CTs.Count > 0)
                    {
                        //Kiểm tra mã vạch có bị trùng hay không
                        MT.Data.BO.Phieu_NhapMuonTra_CT findBysMaVach = phieu_NhapMuonTra_CTs.Find(m => m.sMaVach.Equals(castItem.sMaVach) && m.Id != castItem.Id);
        ...
        protected override void CustomRowCellGridDetail(MGridControl mGridControl, RepositoryItem repository, CustomRowCellEditEventArgs e)
        {
            ...
            switch (mGridControl.TableName)
            {
                case "Phieu_NhapMuonTra_CT":
                    ...
                    {
                        //gán mặc định đơn vị tính cấp 1 cho sản phẩm
                        Phieu_XuatMuonTra_CTRepository ph_XuatMuonTra_CTRepository = DBContext.GetRep2<Phieu_XuatMuonTra_CTRepository>();
                        object sPH_XuatMuonTra_Id_CanCu = cbossPhieu_XuatMuonTra_Id_CanCu.EditValue;
                        MRepositoryItemLookUpEdit repositoryItemLookUpEdit = (MRepositoryItemLookUpEdit)repository;
                        if (sPH_XuatMuonTra_Id_CanCu != null)
                        {
                            repositoryItemLookUpEdit.DataSource = ph_XuatMuonTra_CTRepository
                                                                    .GetPhieu_XuatMuonTra_CTsBysPhieu_XuatMuonTra_Id(Guid.Parse(sPH_XuatMuonTra_Id_CanCu.ToString()));
                        }
                        else
                        {
                    ...
                    {
                        //MT.Data.BO.Phieu_NhapMuonTra curMaster = (MT.Data.BO.Phieu_NhapMuonTra)this.CurrentData;
        ...
        protected override void CustomRowCellValueChangedGridDetail(MGridControl mGridControl, CellValueChangedEventArgs e)
        {
            ...
            switch (mGridControl.TableName)
            {
                case "Phieu_NhapMuonTra_CT":
                    // Noteeeeeeeee
                    Phieu_NhapMuonTra_CT phieu_NhapMuonTra_CT = mGridControl.GetRecordByRowSelected<Phieu_NhapMuonTra_CT>();
                    if (e.Column.FieldName == "sDM_SanPham_Id")
                    {
                        //gán mặc định đơn vị tính cấp 1 cho sản phẩm
                        if (mGridControl.FuncCustomRecordBeforeAddRow != null)
                        {
                            mGridControl.FuncCustomRecordBeforeAddRow(phieu_NhapMuonTra_CT, mGridControl);
                        }
                    }
                    //if (e.Column.FieldName == "sDM_SanPham_Id")
                    //{
                    ...
                    {
                        phieu_NhapMuonTra_CT.rThanhTien = phieu_NhapMuonTra_CT.rSoLuong * phieu_NhapMuonTra_CT.rDonGia;
                    }
                    if (e.Column.FieldName == "sSTTSP")
                    {
                        ...
                        if (objsSTTSP != null)
                        {
                            ...
                            {
                                phieu_NhapMuonTra_CT.rSoLuong = arrSerial.Length;
                            }
                        }
                    }
                    ...
                    if (e.Column.FieldName == "iThoiGianBaoHanh" || e.Column.FieldName == "iDonViThoiGianBaoHanh")
                    {
                        ...
                        switch (phieu_NhapMuonTra_CT.iDonViThoiGianBaoHanh)
                        {
                            case (int)MT.Data.iDonViThoiGianHieuLuc.Ngay:
                                dHanBaoHanhDen =now.AddDays(phieu_NhapMuonTra_CT.iThoiGianBaoHanh).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Thang:
                                dHanBaoHanhDen = now.AddMonths(phieu_NhapMuonTra_CT.iThoiGianBaoHanh).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Quy:
                                dHanBaoHanhDen = now.AddYears(phieu_NhapMuonTra_CT.iThoiGianBaoHanh * 3).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Nam:
                                dHanBaoHanhDen = now.AddYears(phieu_NhapMuonTra_CT.iThoiGianBaoHanh).AddDays(1);
                                break;
                        }
                        phieu_NhapMuonTra_CT.dHanBaoHanhDen = dHanBaoHanhDen;
                    }
                    break;
            }
        }
        ...
        protected override void SetViewModeControlByFromAction()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.Duplicate:
                    cbossPhieu_XuatMuonTra_Id_CanCu.SetReadOnly(false);
                    break;

                default:
                    cbossPhieu_XuatMuonTra_Id_CanCu.SetReadOnly(true);
                    break;
            }
        ...
        {
            var currentData = (Phieu_NhapMuonTra)base.PrepareDataBeforeBindDataForm();
            switch (this.FormAction)
            {
                case (int)MTControl.FormAction.Add:
                case (int)MTControl.FormAction.Duplicate:
                    ...
                    currentData.sPhieu_XuatMuonTra_Id_CanCu = null;
                    break;
            }
        ...
        private void cbossPhieu_NhapMuonTra_Id_CanCu_EditValueChanged(object sender, EventArgs e)
        {
            switch (this.FormAction)
            {
                case (int)MTControl.FormAction.Add:
                case (int)MTControl.FormAction.Duplicate:
                    MT.Data.BO.Phieu_XuatMuonTra pH_XuatMuonTra = cbossPhieu_XuatMuonTra_Id_CanCu.GetRecordSelected<MT.Data.BO.Phieu_XuatMuonTra>();
                    if (pH_XuatMuonTra != null)
                    {
                        // Thiết lập giá trị mặc định cho đơn vị xuất
                        Guid maDVXuat = pH_XuatMuonTra.sDM_DonVi_Id_Xuat;
                        treesDM_DonVi_Id_DonViXuat.SetValue(maDVXuat);

                        // Thiết lập giá trị mặc định cho đơn vị nhập
                        Guid maDVNhap = pH_XuatMuonTra.sDM_DonVi_Id_Nhap;
                        ...
                        cbosDM_CanBo_Id_NguoiGiao.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.DM_CanBoRepository>().GetData(typeof(MT.Data.BO.DM_CanBo),
                           ...
                           orderBy: "sMaCanBo",
                           viewName: "View_DM_CanBo");
                        cbosDM_CanBo_Id_NguoiGiao.SetValue(pH_XuatMuonTra.sDM_CanBo_Id_NguoiGiao);

                        // Nguoi nhập
                        cbosDM_CanBo_Id_NguoiNhap.SetValue(pH_XuatMuonTra.sDM_CanBo_Id_NguoiNhap);

                        //var datas = DBContext.GetRep2<Phieu_NhapMuonTra_CTRepository>().GetPhieu_XuatMuonTra_CTsByMasterId(pH_XuatMuonTra.Id);
        ...
        private void cbossPhieu_XuatMuonTra_Id_CanCu_QueryPopUp(object sender, CancelEventArgs e)
        {
            if (cboEnumiLoaiTCNhap.SelectedIndex == 1)
            {
                cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_XuatMuonTraRepository>().GetData(typeof(MT.Data.BO.Phieu_XuatMuonTra),
                    columns: "Id,sMa,dNgayPhieu_Xuat,sDM_DonVi_Id_Xuat_Ten, sDM_DonVi_Id_Xuat, sDM_DonVi_Id_Nhap,sDM_CanBo_Id_NguoiGiao, sDM_CanBo_Id_NguoiNhap",
                    where: $"iTrangThaiDuyet=1 AND sDM_DonVi_Id_Nhap ='{MT.Library.SessionData.OrganizationUnitId}' AND iTCXuat= 34 AND iTrangThaiThucHienKHNM < {(int)MT.Data.iTrangThaiThucHienKHNM.DaHoanThanh}",
                    orderBy: "sSo DESC",
                    viewName: "View_Phieu_XuatMuonTra");
            }
            else
            {
                cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_XuatMuonTraRepository>().GetData(typeof(MT.Data.BO.Phieu_XuatMuonTra),
                    columns: "Id,sMa,dNgayPhieu_Xuat,sDM_DonVi_Id_Xuat_Ten, sDM_DonVi_Id_Xuat, sDM_DonVi_Id_Nhap,sDM_CanBo_Id_NguoiGiao, sDM_CanBo_Id_NguoiNhap",
                    where: $"iTrangThaiDuyet=1 AND sDM_DonVi_Id_Nhap ='{MT.Library.SessionData.OrganizationUnitId}' AND iTCXuat= 32 AND iTrangThaiThucHienKHNM < {(int)MT.Data.iTrangThaiThucHienKHNM.DaHoanThanh}",
                    orderBy: "sSo DESC",
                    viewName: "View_Phieu_XuatMuonTra"
                    );
            }
        ...
        private void cboEnumiLoaiTCNhap_EditValueChanged(object sender, EventArgs e)
        {
            //if (cboEnumiLoaiTCNhap.SelectedIndex == 1)
            //{
            //    cbossPhieu_XuatMuonTra_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_NhapMuonTraRepository>().GetData(typeof(MT.Data.BO.Phieu_NhapMuonTra),
            //        columns: "Id,sMa,dNgayPhieu_Nhap,sDM_DonVi_Id_Xuat_Ten, sDM_DonVi_Id_Nhap, sDM_DonVi_Id_Xuat",
            //        where: $"sDM_DonVi_Id_Nhap ='{MT.Library.SessionData.OrganizationUnitId}' AND iTCXuat= 34",
            ...
            //        orderBy: "sSo DESC",
            //        viewName: "View_Phieu_XuatMuonTra",
            //        where: $"sDM_DonVi_Id_Nhap ='{MT.Library.SessionData.OrganizationUnitId}' AND iTCXuat= 32"
            //        );
            //}
        }
