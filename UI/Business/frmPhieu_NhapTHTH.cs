...
namespace FormUI
{
    public partial class frmPhieu_NhapTHTH : FormUI.MFormList
    {
        #region"Property"
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_NhapTHTHRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            this.gridMaster.AddColumnText("soPX", "Căn cứ phiếu xuất", "Căn cứ phiếu xuất", 120);
            //this.gridMaster.AddColumnText("sMaPhieu_NhapTHTH", "Mã phiếu xuất","Mã phiếu xuất", 180,isFixWidth:true,fixedStyle:DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("dNgayPhieu_Nhap", "Ngày lập phiếu", 100);
            //this.gridMaster.AddColumnText("sKH_NhapTHTH_Id_CanCu", "Kế hoạch xuất", 150,fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            ...
            //Sản phẩm
            grdSanPham.TableName = "Phieu_NhapTHTH_CT";
            grdSanPham.ViewName = "View_Phieu_NhapTHTH_CT";
            ...
            grdPhuKienDetail.TableName = "Phieu_NhapTHTH_CT_PhuKien";
            grdPhuKienDetail.ViewName = "View_Phieu_NhapTHTH_CT_PhuKien";
        ...
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapTHTH>();
            ...
            foreach (var item in datas)
            {
                ...
                //List<string> pHXuatSP_sMas = DBContext.GetRep2<Phieu_NhapTHTHRepository>().GetPhieuXuatsByKHX(item.Id);
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                ...
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapTHTH>();
                        ...
                        var frmPhieu_NhapTHTH_PheDuyet = new frmPhieu_NhapTHTH_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.DongYDuyet, datasApprove);
                        frmPhieu_NhapTHTH_PheDuyet.ShowDialog();
                        frmPhieu_NhapTHTH_PheDuyet.Dispose();
                    }
                    break;
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapTHTH>();
                        ...
                        var frmPhieu_NhapTHTH_TuChoi = new frmPhieu_NhapTHTH_PheDuyet(this.RefreshData,(int) MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet, datasReject);
                        frmPhieu_NhapTHTH_TuChoi.ShowDialog();
                        frmPhieu_NhapTHTH_TuChoi.Dispose();
                    }
                    break;
            }
        }
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_NhapTHTH_CT")
            {
        ...
        private void frmPhieu_NhapTHTH_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_NhapTHTH_CTRepository>().GetDetailsByMasterID2("View_Phieu_NhapTHTH_CT_PhuKien",
                        "Phieu_NhapTHTH_CT_PhuKien", e.Argument);
            }
            finally
            {
