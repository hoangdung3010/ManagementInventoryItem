...
namespace FormUI
{
    public partial class frmPhieu_XuatCaiDatSanPham : FormUI.MFormList
    {
        #region"Property"
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_XuatCaiDatSanPhamRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            this.gridMaster.AddColumnText("sMa_KH", "Căn cứ số", "Căn cứ số", 120);
            this.gridMaster.AddColumnText("dNgayPhieu_Xuat", "Ngày lập phiếu", 100, dataType: DataTypeColumn.DateEdit);
            ...
            //Sản phẩm
            grdSanPham.TableName = "Phieu_XuatCaiDatSanPham_CT";
            grdSanPham.ViewName = "View_Phieu_XuatCaiDatSanPham_CT";
            ...
            col = grdSanPham.AddColumnText("sDM_ChungThuSo_Id_Ten", "Mã CTS", toolTip: "Mã chứng thư số", 150);
            ...
            grdPhuKienDetail.TableName = "Phieu_XuatCaiDatSanPham_CT_PhuKien";
            grdPhuKienDetail.TableName = "View_Phieu_XuatCaiDatSanPham_CT_PhuKien";
        ...
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatCaiDatSanPham>();
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatCaiDatSanPham>();
                        ...
                        var frmPhieuNhapSanPhamMoi_PheDuyet = new frmPhieu_XuatCaiDatSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPXCĐSP.DongYDuyet, datasApprove);
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatCaiDatSanPham>();
                        ...
                        var frmKH_NhapSanPhamMoi_TuChoi = new frmPhieu_XuatCaiDatSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPXCĐSP.TuChoiDuyet, datasReject);
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_XuatCaiDatSanPham_CT")
            {
        ...
        private void LoadMasterData(object sender, EventArgs e)
        {
            try
            {
                ...
                PagingList.SetWhere($@" dNgayPhieu_Xuat BETWEEN '{drKyBaoCao.FromDate.Value.StartDate()}'
                                    ...
                                    AND (iLoai={cboTCXuat.GetValue()} OR {cboTCXuat.GetValue()}<=-1) ");
                RefreshData();
            }
            catch (Exception ex)
            {
        ...
        private void frmPhieu_XuatCaiDatSanPham_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_XuatCaiDatSanPham_CTRepository>().GetDetailsByMasterID2("View_Phieu_XuatCaiDatSanPham_CT_PhuKien",
                        "Phieu_XuatCaiDatSanPham_CT_PhuKien", e.Argument);
            }
            finally
            {
