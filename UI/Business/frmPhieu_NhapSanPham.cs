...
namespace FormUI
{
    public partial class frmPhieu_NhapSanPham : FormUI.MFormList
    {
        #region"Property"
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_NhapSanPhamRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            // this.gridMaster.AddColumnText("sMaPhieu_NhapSanPham", "Mã phiếu xuất","Mã phiếu xuất", 180,isFixWidth:true,fixedStyle:DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("dNgayPhieu_Nhap", "Ngày lập phiếu", 100);
            // this.gridMaster.AddColumnText("sKH_NhapSanPham_Id_CanCu", "Kế hoạch xuất", 150,fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            ...
            // Sản phẩm
            grdSanPham.TableName = "Phieu_NhapSanPham_CT";
            grdSanPham.ViewName = "View_Phieu_NhapSanPham_CT";
            ...
            grdPhuKienDetail.TableName = "Phieu_NhapSanPham_CT_PhuKien";
            grdPhuKienDetail.ViewName = "View_Phieu_NhapSanPham_CT_PhuKien";
        ...
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapSanPham>();
            ...
            foreach (var item in datas)
            {
                ...
                //List<string> pHXuatSP_sMas = DBContext.GetRep2<Phieu_NhapSanPhamRepository>().GetPhieuXuatsByKHX(item.Id);
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                ...
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapSanPham>();
                        ...
                        var frmPhieu_NhapSanPham_PheDuyet = new frmPhieu_NhapSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.DongYDuyet, datasApprove);
                        frmPhieu_NhapSanPham_PheDuyet.ShowDialog();
                        frmPhieu_NhapSanPham_PheDuyet.Dispose();
                    }
                    break;
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapSanPham>();
                        ...
                        var frmPhieu_NhapSanPham_TuChoi = new frmPhieu_NhapSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet, datasReject);
                        frmPhieu_NhapSanPham_TuChoi.ShowDialog();
                        frmPhieu_NhapSanPham_TuChoi.Dispose();
                    }
                    break;
            }
        }
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_NhapSanPham_CT")
            {
        ...
        private void frmPhieu_NhapSanPham_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_NhapSanPham_CTRepository>().GetDetailsByMasterID2("View_Phieu_NhapSanPham_CT_PhuKien",
                        "Phieu_NhapSanPham_CT_PhuKien", e.Argument);
            }
            finally
            {
