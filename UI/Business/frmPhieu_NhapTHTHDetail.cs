...
namespace FormUI
{
    public partial class frmPhieu_NhapTHTHDetail : FormUI.MFormBusinessDetail
    {
        private DM_DonViRepository dM_DonViRepository;

        public frmPhieu_NhapTHTHDetail()
        {
            InitializeComponent();
            ...
            if (ConfigFormDetail == null)
            {
                ...
                {
                    Rep = DBContext.GetRep<Phieu_NhapTHTHRepository>(),
                    EntityName = "Phieu_NhapTHTH",
                    Title = "Phiếu nhập sản phẩm thu hồi"
                };
            }

            GrdDetails = new Dictionary<string, MTControl.MGridEditable>
            {
                {"Phieu_NhapTHTH_CT",grdSanPham }
            };
        ...
        private void InitLookup()
        {
            ...
            // Phieu xuat
            //cbossPhieu_XuatTHTH_Id_CanCu.Properties.DisplayMember = "sMa";
            //cbossPhieu_XuatTHTH_Id_CanCu.Properties.ValueMember = "Id";
            //cbossPhieu_XuatTHTH_Id_CanCu.AddColumn("sMa", "Số phiếu xuất", 180, true);
            //cbossPhieu_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_XuatTHTHRepository>().GetData(typeof(MT.Data.BO.Phieu_XuatTHTH),
            //    columns: "Id,sMa", orderBy: "sMa");
            cbossPhieu_XuatTHTH_Id_CanCu.Properties.DisplayMember = "sMa";
            cbossPhieu_XuatTHTH_Id_CanCu.Properties.ValueMember = "Id";
            cbossPhieu_XuatTHTH_Id_CanCu.AddColumn("sMa", "Số phiếu xuất", 120);
            cbossPhieu_XuatTHTH_Id_CanCu.AddColumn("dNgayPhieu_Xuat", "Ngày lập", 80);
            cbossPhieu_XuatTHTH_Id_CanCu.AddColumn("sDM_DonVi_Id_Xuat_Ten", "Đơn vị lập", 120);
            ...
            linkFormVoucher.ControlVoucher = cbossPhieu_XuatTHTH_Id_CanCu;
            linkFormVoucher.TableName = "Phieu_XuatTHTH";

            cboEnumiLoaiTCNhap.EnumData = "iTCNhapTH";
        }
        ...
        private void InitGrid()
        {
            ...
            //Sản phẩm
            grdSanPham.GrdDetail.TableName = "Phieu_NhapTHTH_CT";
            grdSanPham.GrdDetail.ViewName = "View_Phieu_NhapTHTH_CT";
            grdSanPham.GrdDetail.KeyName = "Id";
            grdSanPham.GrdDetail.SetField = "phieu_NhapTHTH_CTs";
            ...
            col = grdSanPham.GrdDetail.AddColumnText("sPhieu_XuatTHTH_CT_Id", "sPhieu_XuatTHTH_CT_Id", 0);
            col.Visible = false;
        }
        ...
        private bool grdSanPham_ColsMaVach_CustomEventEnter(MRepositoryTextEdit mRepositoryTextEdit, MTextEdit mTextEdit)
        {
            try
            {
                ...
                if (mTextEdit.EditValue != null)
                {
                    ...
                    //List<MT.Data.BO.Phieu_NhapTHTH_CT> phieu_NhapTHTH_CTs = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapTHTH_CT>();
                    // Truong Added 14.6:
                    List<MT.Data.BO.Phieu_NhapTHTH_CT> phieu_NhapTHTH_CTs_current = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapTHTH_CT>();
                    Phieu_NhapTHTH_CT phieu_NhapTHTH_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapTHTH_CT>();

                    // 1. Kiểm tra nếu mã vạch đã có trên danh sách rồi thì không cho nhập, cảnh báo trùng
                    MT.Data.BO.Phieu_NhapTHTH_CT findBysMaVach_current = phieu_NhapTHTH_CTs_current.Find(m => m.sMaVach.Equals(sMaVach) && m.Id != phieu_NhapTHTH_CT.Id);
                    ...
                    if (lkMaVachCTS != null)
                    {
                        phieu_NhapTHTH_CT.sDM_ChungThuSo_Id = lkMaVachCTS.sDM_ChungThuSo_Id;
                    }
                    ...
                    if (lkMaVachMLL != null)
                    {
                        phieu_NhapTHTH_CT.sDM_MangLienLac_Id = lkMaVachMLL.sDM_MangLienLac_Id;
                    }

                    Guid? sPhieuXuatTHTH_Id = null;
                    if (cbossPhieu_XuatTHTH_Id_CanCu.EditValue != null)
                        sPhieuXuatTHTH_Id = Guid.Parse(cbossPhieu_XuatTHTH_Id_CanCu.EditValue.ToString());

                    if (sPhieuXuatTHTH_Id.HasValue)
                    {
                        Phieu_XuatTHTH_CT phieu_XuatTHTH_CT = DBContext.GetRep2<Phieu_XuatTHTH_CTRepository>()
                                                                    .GetPhieu_XuatTHTH_CTBysPhieu_XuatTHTH_CT_IdAndsMaSP(sPhieuXuatTHTH_Id, sMaVach);
                        if (phieu_XuatTHTH_CT == null)
                        {
                            MMessage.ShowWarning($@"Phiếu xuất <{cbossPhieu_XuatTHTH_Id_CanCu.Text}> không tồn tại sản phẩm có mã vạch <{sMaVach}>");
                            return true;
                        }

                        //Lấy chi tiết phụ kiện theo phiếu xuất
                        List<MT.Data.BO.Phieu_XuatTHTH_CT_PhuKien> phieu_XuatTHTH_CT_PhuKiens = DBContext.GetRep2<Phieu_XuatTHTH_CT_PhuKienRepository>()
                                                                                                    .GetPhieu_XuatTHTH_CT_PhuKiensBysPhieu_XuatTHTH_CT_Id(phieu_XuatTHTH_CT.Id);
                        List<MT.Data.BO.Phieu_NhapTHTH_CT_PhuKien> phieu_NhapTHTH_CT_PhuKiens = new List<Phieu_NhapTHTH_CT_PhuKien>();
                        if (phieu_XuatTHTH_CT_PhuKiens != null)
                        {
                            foreach (var item in phieu_XuatTHTH_CT_PhuKiens)
                            {
                                phieu_NhapTHTH_CT_PhuKiens.Add(new Phieu_NhapTHTH_CT_PhuKien
                                {
                                    Id = Guid.NewGuid(),
                        ...
                        phieu_NhapTHTH_CT.phieu_NhapTHTH_CT_PhuKiens = phieu_NhapTHTH_CT_PhuKiens;
                        phieu_NhapTHTH_CT.sPhieu_XuatTHTH_CT_Id = phieu_XuatTHTH_CT.Id;
                        phieu_NhapTHTH_CT.sPhieu_XuatTHTH_Id = sPhieuXuatTHTH_Id; // Note 14.6
                        phieu_NhapTHTH_CT.sDM_SanPham_Id = phieu_XuatTHTH_CT.sDM_SanPham_Id;
                        phieu_NhapTHTH_CT.sDM_DonViTinh_Id = phieu_XuatTHTH_CT.sDM_DonViTinh_Id;
                        phieu_NhapTHTH_CT.rDonGia = phieu_XuatTHTH_CT.rDonGia;
                        phieu_NhapTHTH_CT.rThanhTien = phieu_XuatTHTH_CT.rDonGia;
                        phieu_NhapTHTH_CT.sDM_SanPham_Id_Ten = phieu_XuatTHTH_CT.sDM_SanPham_Id_Ten;
                        //phieu_NhapTHTH_CT.sDM_MangLienLac_Id = phieu_XuatTHTH_CT.sDM_MangLienLac_Id;
                        //phieu_NhapTHTH_CT.sDM_MangLienLac_Id_Ten = phieu_XuatTHTH_CT.sDM_MangLienLac_Id_Ten;

                        /*phieu_NhapTHTH_CT.iThoiGianBaoHanh = phieu_XuatTHTH_CT.iThoiGianBaoHanh;
                        phieu_NhapTHTH_CT.iDonViThoiGianBaoHanh = phieu_XuatTHTH_CT.iDonViThoiGianBaoHanh;
                        phieu_NhapTHTH_CT.dHanBaoHanhDen = phieu_XuatTHTH_CT.dHanBaoHanhDen;
                        phieu_NhapTHTH_CT.iNamSX = phieu_XuatTHTH_CT.iNamSX;*/
                        phieu_NhapTHTH_CT.sXuatXu = phieu_XuatTHTH_CT.sXuatXu;
                        phieu_NhapTHTH_CT.sGhiChu = phieu_XuatTHTH_CT.sGhiChu;
                        phieu_NhapTHTH_CT.sSTTSP = phieu_XuatTHTH_CT.sSTTSP;
                    }
                    else
                    {
                        ...
                        if (dm_SanPhams?.Count > 0)
                        {
                            ...
                            phieu_NhapTHTH_CT.sDM_SanPham_Id = dM_SanPham.Id;
                            phieu_NhapTHTH_CT.sDM_DonViTinh_Id = dM_SanPham.sDM_DonViTinh_Id_Cap1;
                            phieu_NhapTHTH_CT.rDonGia = dM_SanPham.rDonGia_Cap1;
                            phieu_NhapTHTH_CT.rThanhTien = dM_SanPham.rDonGia_Cap1;
                            phieu_NhapTHTH_CT.sDM_SanPham_Id_Ten = dM_SanPham.sTenSanPham;
                            ...
                            phieu_NhapTHTH_CT.sSTTSP = string.Empty;

                            phieu_NhapTHTH_CT.sPhieu_XuatTHTH_Id = null;
                            phieu_NhapTHTH_CT.sDM_SanPham_Id = null;
                        }
                    }

                    phieu_NhapTHTH_CT.IsLoaded = true;
                    phieu_NhapTHTH_CT.sSerial = sSerial;
                    phieu_NhapTHTH_CT.rSoLuong = 1;
                    ...
                    if (dm_Phieu_NhapSanPhamMois != null && dm_Phieu_NhapSanPhamMois.Count == 1)
                    {
                        ...
                        phieu_NhapTHTH_CT.iThoiGianBaoHanh = curPNM.iThoiGianBaoHanh;
                        phieu_NhapTHTH_CT.iDonViThoiGianBaoHanh = curPNM.iDonViThoiGianBaoHanh;
                        phieu_NhapTHTH_CT.iNamSX = curPNM.iNamSX;
                        phieu_NhapTHTH_CT.dHanBaoHanhDen = curPNM.dHanBaoHanhDen;
                    }
        ...
        private void ColsActionPhuKien_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            var phieu_NhapTHTH_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapTHTH_CT>();
            if (phieu_NhapTHTH_CT.sDM_SanPham_Id.HasValue && !phieu_NhapTHTH_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                //frmPhieu_NhapTHTH_CT_PhuKienDetail frmPhieu_NhapTHTH_CT_PhuKienDetail = new frmPhieu_NhapTHTH_CT_PhuKienDetail(grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapTHTH_CT>());
                frmPhuKienDetail frmPhuKienDetail = new frmPhuKienDetail(phieu_NhapTHTH_CT.sDM_SanPham_Id.Value,
                    "Phieu_NhapTHTH_CT_PhuKien", "phieu_NhapTHTH_CT_PhuKiens", phieu_NhapTHTH_CT, this);
        ...
        private bool grdSanPham_ValidEditValueChanging(DevExpress.XtraGrid.Columns.GridColumn gridColumn, ChangingEventArgs e)
        {
            if (cbossPhieu_XuatTHTH_Id_CanCu.EditValue == null)
            {
                ActiveControl = cbossPhieu_XuatTHTH_Id_CanCu;
            ...
            if (gridColumn.FieldName == "sSerial" && e.NewValue != null && !object.Equals(e.OldValue, e.NewValue))
            {
                ...
                Phieu_NhapTHTH_CT phieu_NhapTHTH = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_NhapTHTH_CT>();
                if (arrSerial.Length > 0 && (decimal)arrSerial.Length > phieu_NhapTHTH.rSoLuong)
                {
                    e.NewValue = string.Empty;
                    MMessage.ShowWarning($"Bạn chỉ được phép chọn tối đa {(int)phieu_NhapTHTH.rSoLuong} số serial");
                    return false;
                }
            }
        ...
        {
            Phieu_NhapTHTH_CT phieu_NhapTHTH_CT = (Phieu_NhapTHTH_CT)newRecord;
            if (phieu_NhapTHTH_CT.sDM_SanPham_Id.HasValue
                && !phieu_NhapTHTH_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                if (cbossPhieu_XuatTHTH_Id_CanCu.EditValue == null)
                {
                    ActiveControl = cbossPhieu_XuatTHTH_Id_CanCu;
        ...
        protected override void BindingDataIntoFormSucces()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.View:
                    ...
                    ucThamChieuPhieuNhapMoi.sTenBangCanCu = "Phieu_NhapTHTH";
        ...
        protected override void SetConfigBeforePrint(MT.Data.BO.ConfigExcel configExcel, ConfigReport configReport)
        {
            ...
            configReport.RepName = "Print_Phieu_NhapTHTH_DetailRepository";
            //Định danh mẫu in trong bảng ReportData
            configReport.DictionaryKey = MT.Data.ReportDictionaryKey.RP_Print_Phieu_NhapTHTHDetail;
        ...
        protected override bool IsValidateDataChangedGridDetail(MGridEditable mGridEditable, System.Collections.IList dataChanged)
        {
            ...
            {
                List<MT.Data.BO.Phieu_NhapTHTH_CT> phieu_NhapTHTH_CTs = mGridEditable.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapTHTH_CT>();

                foreach (var item in dataChanged)
                {
                    var castItem = (MT.Data.BO.Phieu_NhapTHTH_CT)item;
                    ...
                    if (isValid && phieu_NhapTHTH_CTs != null && phieu_NhapTHTH_CTs.Count > 0)
                    {
                        //Kiểm tra mã vạch có bị trùng hay không
                        MT.Data.BO.Phieu_NhapTHTH_CT findBysMaVach = phieu_NhapTHTH_CTs.Find(m => m.sMaVach.Equals(castItem.sMaVach) && m.Id != castItem.Id);
        ...
        protected override void CustomRowCellGridDetail(MGridControl mGridControl, RepositoryItem repository, CustomRowCellEditEventArgs e)
        {
            ...
            switch (mGridControl.TableName)
            {
                case "Phieu_NhapTHTH_CT":
                    ...
                    {
                        //gán mặc định đơn vị tính cấp 1 cho sản phẩm
                        Phieu_XuatTHTH_CTRepository ph_XuatTHTH_CTRepository = DBContext.GetRep2<Phieu_XuatTHTH_CTRepository>();
                        object sPH_XuatTHTH_Id_CanCu = cbossPhieu_XuatTHTH_Id_CanCu.EditValue;
                        MRepositoryItemLookUpEdit repositoryItemLookUpEdit = (MRepositoryItemLookUpEdit)repository;
                        if (sPH_XuatTHTH_Id_CanCu != null)
                        {
                            repositoryItemLookUpEdit.DataSource = ph_XuatTHTH_CTRepository
                                                                    .GetPhieu_XuatTHTH_CTsBysPhieu_XuatTHTH_Id(Guid.Parse(sPH_XuatTHTH_Id_CanCu.ToString()));
                        }
                        else
                        {
                    ...
                    {
                        //MT.Data.BO.Phieu_NhapTHTH curMaster = (MT.Data.BO.Phieu_NhapTHTH)this.CurrentData;
        ...
        protected override void CustomRowCellValueChangedGridDetail(MGridControl mGridControl, CellValueChangedEventArgs e)
        {
            ...
            switch (mGridControl.TableName)
            {
                case "Phieu_NhapTHTH_CT":
                    // Noteeeeeeeee
                    Phieu_NhapTHTH_CT phieu_NhapTHTH_CT = mGridControl.GetRecordByRowSelected<Phieu_NhapTHTH_CT>();
                    if (e.Column.FieldName == "sDM_SanPham_Id")
                    {
                        //gán mặc định đơn vị tính cấp 1 cho sản phẩm
                        if (mGridControl.FuncCustomRecordBeforeAddRow != null)
                        {
                            mGridControl.FuncCustomRecordBeforeAddRow(phieu_NhapTHTH_CT, mGridControl);
                        }
                    }
                    //if (e.Column.FieldName == "sDM_SanPham_Id")
                    //{
                    ...
                    {
                        phieu_NhapTHTH_CT.rThanhTien = phieu_NhapTHTH_CT.rSoLuong * phieu_NhapTHTH_CT.rDonGia;
                    }
                    if (e.Column.FieldName == "sSerial")
                    {
                        ...
                        if (objsSerial != null)
                        {
                            ...
                            {
                                phieu_NhapTHTH_CT.rSoLuong = arrSerial.Length;
                            }
                        }
                    }
                    ...
                    if (e.Column.FieldName == "iThoiGianBaoHanh" || e.Column.FieldName == "iDonViThoiGianBaoHanh")
                    {
                        ...
                        switch (phieu_NhapTHTH_CT.iDonViThoiGianBaoHanh)
                        {
                            case (int)MT.Data.iDonViThoiGianHieuLuc.Ngay:
                                dHanBaoHanhDen = now.AddDays(phieu_NhapTHTH_CT.iThoiGianBaoHanh).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Thang:
                                dHanBaoHanhDen =now.AddMonths(phieu_NhapTHTH_CT.iThoiGianBaoHanh).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Quy:
                                dHanBaoHanhDen =now.AddYears(phieu_NhapTHTH_CT.iThoiGianBaoHanh * 3).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Nam:
                                dHanBaoHanhDen = now.AddYears(phieu_NhapTHTH_CT.iThoiGianBaoHanh).AddDays(1);
                                break;
                        }
                        phieu_NhapTHTH_CT.dHanBaoHanhDen = dHanBaoHanhDen;
                    }
                    break;
            }
        }
        ...
        protected override void SetViewModeControlByFromAction()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.Duplicate:
                    cbossPhieu_XuatTHTH_Id_CanCu.SetReadOnly(false);
                    break;

                default:
                    cbossPhieu_XuatTHTH_Id_CanCu.SetReadOnly(true);
                    break;
            }
        ...
        {
            var currentData = (Phieu_NhapTHTH)base.PrepareDataBeforeBindDataForm();
            switch (this.FormAction)
            {
                case (int)MTControl.FormAction.Add:
                case (int)MTControl.FormAction.Duplicate:
                    ...
                    currentData.sPhieu_XuatTHTH_Id_CanCu = null;
                    break;
            }
        ...
        private void cbossPhieu_NhapTHTH_Id_CanCu_EditValueChanged(object sender, EventArgs e)
        {
            switch (this.FormAction)
            {
                case (int)MTControl.FormAction.Add:
                case (int)MTControl.FormAction.Duplicate:
                    MT.Data.BO.Phieu_XuatTHTH pH_XuatTHTH = cbossPhieu_XuatTHTH_Id_CanCu.GetRecordSelected<MT.Data.BO.Phieu_XuatTHTH>();
                    if (pH_XuatTHTH != null)
                    {
                        // Thiết lập giá trị mặc định cho đơn vị xuất
                        Guid maDVXuat = pH_XuatTHTH.sDM_DonVi_Id_Xuat;
                        treesDM_DonVi_Id_DonViXuat.SetValue(maDVXuat);

                        // Thiết lập giá trị mặc định cho đơn vị nhập
                        Guid maDVNhap = pH_XuatTHTH.sDM_DonVi_Id_Nhap;
                        ...
                        cbosDM_CanBo_Id_NguoiGiao.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.DM_CanBoRepository>().GetData(typeof(MT.Data.BO.DM_CanBo),
                           ...
                           orderBy: "sMaCanBo",
                           viewName: "View_DM_CanBo");
                        cbosDM_CanBo_Id_NguoiGiao.SetValue(pH_XuatTHTH.sDM_CanBo_Id_NguoiGiao);

                        // Nguoi nhập
                        cbosDM_CanBo_Id_NguoiNhap.SetValue(pH_XuatTHTH.sDM_CanBo_Id_NguoiNhap);

                        //var datas = DBContext.GetRep2<Phieu_NhapTHTH_CTRepository>().GetPhieu_XuatTHTH_CTsByMasterId(pH_XuatTHTH.Id);
        ...
        private void cbossPhieu_XuatTHTH_Id_CanCu_QueryPopUp(object sender, CancelEventArgs e)
        {
            cbossPhieu_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_XuatTHTHRepository>().GetData(typeof(MT.Data.BO.Phieu_XuatTHTH),
                    columns: "Id,sMa,dNgayPhieu_Xuat,sDM_DonVi_Id_Xuat_Ten, sDM_DonVi_Id_Xuat, sDM_DonVi_Id_Nhap,sDM_CanBo_Id_NguoiGiao, sDM_CanBo_Id_NguoiNhap",
                    where: $"iTrangThaiDuyet=1 AND iTrangThaiThucHienKHNM < {(int)MT.Data.iTrangThaiThucHienKHNM.DaHoanThanh} AND sDM_DonVi_Id_Nhap ='{MT.Library.SessionData.OrganizationUnitId}' AND iTCXuat= " + (int)iLoaiPhieu.XuatThuHoi,
                    orderBy: "sSo DESC",
                    viewName: "View_Phieu_XuatTHTH");
            linkFormVoucher.VoucherId = null;
            linkFormVoucher.ControlVoucher = cbossPhieu_XuatTHTH_Id_CanCu;
        ...
        private void cboEnumiLoaiTCNhap_EditValueChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    cbossPhieu_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_NhapTHTHRepository>().GetData(typeof(MT.Data.BO.Phieu_NhapTHTH),
