...
namespace FormUI
{
    public partial class frmKH_BaoHanhSanPhamDetail : FormUI.MFormBusinessDetail
    {
        DM_DonViRepository dM_DonViRepository;
        public frmKH_BaoHanhSanPhamDetail()
        {
            InitializeComponent();
            ...
            if (ConfigFormDetail == null)
            {
                ...
                {
                    Rep = DBContext.GetRep<KH_BaoHanhSanPhamRepository>(),
                    EntityName = "KH_BaoHanhSanPham",
                    Title = "Kế hoạch bảo hành sản phẩm"
                };
            }

            GrdDetails = new Dictionary<string, MTControl.MGridEditable>
            {
                {"KH_BaoHanhSanPham_CT",grdSanPham }
            };
        ...
        private void InitLookup()
        {
            ...
            // Đơn vị nhập
            var donviNhapBaoHanh = dM_DonViRepository.GetDonViConCap1VaDonViCungCapVaNhaCungCap(MT.Library.SessionData.OrganizationUnitId, uuTienNhaCC: true);
            ...
            treesDM_DonVi_Id_DonViNhap.Properties.DataSource = donviNhapBaoHanh;
        ...
        private void InitGrid()
        {
            ...
            grdSanPham.GrdDetail.TableName = "KH_BaoHanhSanPham_CT";
            grdSanPham.GrdDetail.KeyName = "Id";
            grdSanPham.GrdDetail.SetField = "kH_BaoHanhSanPham_CTs";
            ...
            colsDM_SanPham_Id.AddColumn("sTenSanPham", "Nhóm sản phẩm", 180);
            ...
            //colsDM_SanPham_Id.QueryPopUp -= colsDM_SanPham_Id_QueryPopUp;
            //colsDM_SanPham_Id.QueryPopUp += colsDM_SanPham_Id_QueryPopUp;
        ...
        private void ColsActionPhuKien_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            var kh_BaoHanhSanPham_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<KH_BaoHanhSanPham_CT>();
            if (kh_BaoHanhSanPham_CT.sDM_SanPham_Id.HasValue && !kh_BaoHanhSanPham_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                frmPhuKienDetail frmPhuKienDetail = new frmPhuKienDetail(kh_BaoHanhSanPham_CT.sDM_SanPham_Id.Value,
                    "KH_BaoHanhSanPham_CT_PhuKien", "kH_BaoHanhSanPham_CT_PhuKiens", kh_BaoHanhSanPham_CT, this);
        ...
        protected override bool IsValidateDataChangedGridDetail(MGridEditable mGridEditable, System.Collections.IList dataChanged)
        {
            ...
            {
                List<KH_BaoHanhSanPham_CT> datas = mGridEditable.GrdDetail.GetAllData<KH_BaoHanhSanPham_CT>();
                foreach (var item in dataChanged)
                {
                    var castItem = (KH_BaoHanhSanPham_CT)item;
                    // Truong 2022
                    KH_BaoHanhSanPham_CT findBysID = datas.Find(m => m.sDM_SanPham_Id.Equals(castItem.sDM_SanPham_Id) && m.Id != castItem.Id);
                    if (findBysID != null)
                    {
                    ...
                    {
                        valid = false;
                        DM_SanPham dM_SanPham = DBContext.GetRep2<KH_BaoHanhSanPhamRepository>().GetDataByID<DM_SanPham>("DM_SanPham", castItem.sDM_SanPham_Id, "sMaSanPham,sTenSanPham");
                        DM_DonViTinh dM_DonViTinh = DBContext.GetRep2<KH_BaoHanhSanPhamRepository>().GetDataByID<DM_DonViTinh>("DM_DonViTinh", castItem.sDM_DonViTinh_Id, "sTenDonViTinh");
        ...
        protected override void CustomRowCellValueChangedGridDetail(MGridControl mGridControl, CellValueChangedEventArgs e)
        {
            ...
            {
                case "KH_BaoHanhSanPham_CT":
                    KH_BaoHanhSanPham_CT kH_BaoHanhSanPham_CT = mGridControl.GetRecordByRowSelected<KH_BaoHanhSanPham_CT>();
                    if (e.Column.FieldName == "sDM_SanPham_Id")
                    {
                        // Truong2022
                        List<MT.Data.BO.KH_BaoHanhSanPham_CT> kH_BaoHanhSanPham_CTs = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.KH_BaoHanhSanPham_CT>();
                        KH_BaoHanhSanPham_CT findBysID = kH_BaoHanhSanPham_CTs.Find(m => m.sDM_SanPham_Id.Equals(kH_BaoHanhSanPham_CT.sDM_SanPham_Id) && m.Id != kH_BaoHanhSanPham_CT.Id);
                        if (findBysID != null)
                        {
                        ...
                        if (dM_SanPham != null)
                        {
                            ...
                            if (dM_SanPham != null)
                            {
                                ...
                                kH_BaoHanhSanPham_CT.sDM_DonViTinh_Id = dM_SanPham.sDM_DonViTinh_Id_Cap1;
                                kH_BaoHanhSanPham_CT.rSoLuong = 1;
                                kH_BaoHanhSanPham_CT.rDonGia = dM_SanPham.rDonGia_Cap1;
                                kH_BaoHanhSanPham_CT.rThanhTien = dM_SanPham.rDonGia_Cap1;
                                ...
                                if (!kH_BaoHanhSanPham_CT.IsLoaded && kH_BaoHanhSanPham_CT.MTEntityState == Enummation.MTEntityState.Add)
                                {
                                    ...
                                    var phuKiensCuaSanPham = (List<DM_PhuKien>)DBContext.GetRep2<DM_PhuKienRepository>()
                                                                    ...
                                                                    , where: $"sDM_SanPham_Id='{kH_BaoHanhSanPham_CT.sDM_SanPham_Id.Value}'"
                                                                    , orderBy: "SortOrder");
                                    List<KH_BaoHanhSanPham_CT_PhuKien> kH_BaoHanhSanPham_CT_PhuKiens = new List<KH_BaoHanhSanPham_CT_PhuKien>();
                                    if (phuKiensCuaSanPham != null)
                                    {
                                        foreach (var item in phuKiensCuaSanPham)
                                        {
                                            kH_BaoHanhSanPham_CT_PhuKiens.Add(new KH_BaoHanhSanPham_CT_PhuKien
                                            {
                                                Id = Guid.NewGuid(),
                                                rSoLuongPhuKienTren1SP = item.rSoLuong,
                                                rSoLuong = kH_BaoHanhSanPham_CT.rSoLuong * item.rSoLuong,
                                                ...
                                                rThanhTien = kH_BaoHanhSanPham_CT.rSoLuong * item.rSoLuong * item.rDonGia,
                                                sXuatXu = item.sXuatXu,
                                                sDM_SanPham_Id = item.sDM_SanPham_Id
                                            });
                                        }
                                    }
                                    kH_BaoHanhSanPham_CT.kH_BaoHanhSanPham_CT_PhuKiens = kH_BaoHanhSanPham_CT_PhuKiens;
                                }
                            }
                    ...
                    {
                        mGridControl.FirstView.SetRowCellValue(e.RowHandle, "rThanhTien", kH_BaoHanhSanPham_CT.rSoLuong * kH_BaoHanhSanPham_CT.rDonGia);
                    }
                    break;
            }
        }
        ...
        protected override void BindingDataIntoFormSucces()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.View:
                    ...
                    ucThamChieu.sTenBangCanCu = "KH_BaoHanhSanPham";
        ...
        {
            var currentData = (KH_BaoHanhSanPham)base.PrepareDataBeforeBindDataForm();
        ...
        protected override void SetConfigBeforePrint(ConfigExcel configExcel, ConfigReport configReport)
        {
            ...
            configReport.RepName = "Print_KH_BaoHanhSanPham_DetailRepository";
            //Định danh mẫu in trong bảng ReportData
            configReport.DictionaryKey = MT.Data.ReportDictionaryKey.RP_Print_KH_BaoHanhSanPhamDetail;
