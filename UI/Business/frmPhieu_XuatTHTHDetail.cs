...
namespace FormUI
{
    public partial class frmPhieu_XuatTHTHDetail : FormUI.MFormBusinessDetail
    {
        private DM_DonViRepository dM_DonViRepository;

        public frmPhieu_XuatTHTHDetail()
        {
            InitializeComponent();
            ...
            if (ConfigFormDetail == null)
            {
                ConfigFormDetail = new ConfigFormDetail
                {
                    ...
                    Title = "Phiếu xuất thu hồi, tiêu hủy sản phẩm"
                };
            }
        ...
        protected override void BindingDataIntoFormSucces()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.View:
                    ...
                    ucThamChieuPhieuNhapMoi.sTenBangCanCu = "Phieu_XuatTHTH";
        ...
        private void InitLookup()
        {
            ...
            cbossKH_XuatTHTH_Id_CanCu.Properties.DisplayMember = "sMa";
            cbossKH_XuatTHTH_Id_CanCu.Properties.ValueMember = "Id";
            cbossKH_XuatTHTH_Id_CanCu.AddColumn("sMa", "Số kế hoạch", 80);
            cbossKH_XuatTHTH_Id_CanCu.AddColumn("dNgayKeHoach", "Ngày lập", 80);
            cbossKH_XuatTHTH_Id_CanCu.AddColumn("sDM_DonVi_Id_DonViXayDungKH_Ten", "Đơn vị lập", 120);
            cbossKH_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.KH_XuatTHTHRepository>().GetData(typeof(MT.Data.BO.KH_XuatTHTH),
                orderBy: "sSo DESC", viewName: "View_KH_XuatTHTH_UNION_Phieu_NhapTHTH");
            ...
            //cbossKH_XuatTHTH_Id_CanCu.AddColumn("dNgayKeHoach", "Ngày lập", 80);
            //cbossKH_XuatTHTH_Id_CanCu.AddColumn("sDM_DonVi_Id_DonViXayDungKH_Ten", "Đơn vị lập", 120);
            ////cbossKH_XuatTHTH_Id_CanCu.AddColumn("iThoiGianHieuLuc", "Thời gian hiệu lực", 120, true);
            //cbossKH_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.KH_XuatTHTHRepository>().GetData(typeof(MT.Data.BO.KH_XuatTHTH),
            ...
            //    orderBy: "sSo DESC", viewName: "View_KH_XuatTHTH");
            ...
            linkFormVoucher.ControlVoucher = cbossKH_XuatTHTH_Id_CanCu;
            linkFormVoucher.TableName = "KH_XuatTHTH";
        ...
        private void InitGrid()
        {
            ...
            //Sản phẩm
            grdSanPham.GrdDetail.TableName = "Phieu_XuatTHTH_CT";
            grdSanPham.GrdDetail.ViewName = "View_Phieu_XuatTHTH_CT";
            grdSanPham.GrdDetail.KeyName = "Id";
            grdSanPham.GrdDetail.SetField = "phieu_XuatTHTH_CTs";
            ...
            col = grdSanPham.GrdDetail.AddColumnText("sKH_XuatTHTH_CT_Id", "sKH_XuatTHTH_CT_Id", 0);
            col.Visible = false;
        }
        ...
        private bool grdSanPham_ColsMaVach_CustomEventEnter(MRepositoryTextEdit mRepositoryTextEdit, MTextEdit mTextEdit)
        {
            try
            {
                ...
                if (mTextEdit.EditValue != null)
                {
                    ...
                    //List<MT.Data.BO.Phieu_XuatTHTH_CT> phieu_XuatTHTH_CTs = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.Phieu_XuatTHTH_CT>();

                    // Truong Added 14.6:
                    List<MT.Data.BO.Phieu_XuatTHTH_CT> phieu_XuatTHTH_CTs_current = grdSanPham.GrdDetail.GetAllData<MT.Data.BO.Phieu_XuatTHTH_CT>();

                    Phieu_XuatTHTH_CT phieu_XuatTHTH_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_XuatTHTH_CT>();
                    // 1. Kiểm tra nếu mã vạch đã có trên danh sách rồi thì không cho nhập, cảnh báo trùng
                    MT.Data.BO.Phieu_XuatTHTH_CT findBysMaVach_current = phieu_XuatTHTH_CTs_current.Find(m => m.sMaVach.Equals(sMaVach) && m.Id != phieu_XuatTHTH_CT.Id);
                    ...
                    //DBContext.get KiemTraKepChi(int iTCXuat, IList phieu_XuatTHTH_CTs, out string tensp)
                    ...
                    if (lkMaVachCTS != null)
                    {
                        phieu_XuatTHTH_CT.sDM_ChungThuSo_Id = lkMaVachCTS.sDM_ChungThuSo_Id;
                    }
                    ...
                    if (lkMaVachMLL != null)
                    {
                        phieu_XuatTHTH_CT.sDM_MangLienLac_Id = lkMaVachMLL.sDM_MangLienLac_Id;
                    }

                    Guid? sKH_XuatTHTH_Id = null;
                    if (cbossKH_XuatTHTH_Id_CanCu.EditValue != null)
                        sKH_XuatTHTH_Id = Guid.Parse(cbossKH_XuatTHTH_Id_CanCu.EditValue.ToString());

                    // Trường hợp xuất đi ban đầu
                    if (cboEnumiLoaiTCXuat.SelectedIndex == 0)
                    {
                        if (sKH_XuatTHTH_Id.HasValue)
                        {
                            KH_XuatTHTH_CT kH_XuatTHTH_CT = DBContext.GetRep2<KH_XuatTHTH_CTRepository>()
                                                                   .GetKH_XuatTHTH_CTBysKH_XuatTHTH_IdAndsMaSP(sKH_XuatTHTH_Id, sMaSP);
                            if (kH_XuatTHTH_CT == null)
                            {
                                MMessage.ShowWarning($@"Kế hoạch xuất <{cbossKH_XuatTHTH_Id_CanCu.Text}> không tồn tại sản phẩm <{sMaSP}>");
                                return true;
                            }

                            //3. Kiểm tra sản phẩm đã nhập đủ so với kế hoạch chưa, nếu đủ rồi thì không cho nhập nữa
                            List<MT.Data.BO.Phieu_XuatTHTH_CT> phieu_XuatTHTH_CTs_others = DBContext.GetRep2<Phieu_XuatTHTH_CTRepository>().GetAllPhieuXuatCT(MT.Library.SessionData.OrganizationUnitId, (int)iLoaiPhieu.XuatMuon, kH_XuatTHTH_CT.Id);
                            decimal sl_others = phieu_XuatTHTH_CTs_others
                                .Where(m => m.sDM_SanPham_Id.Equals(kH_XuatTHTH_CT.sDM_SanPham_Id) && m.Id != phieu_XuatTHTH_CT.Id)
                                .Sum(m => m.rSoLuong);

                            decimal sl_current = phieu_XuatTHTH_CTs_current
                                .Where(m => m.sDM_SanPham_Id.Equals(kH_XuatTHTH_CT.sDM_SanPham_Id) && m.Id != phieu_XuatTHTH_CT.Id)
                                .Sum(m => m.rSoLuong);
                            if (sl_others + sl_current >= kH_XuatTHTH_CT.rSoLuong)
                            {
                                MMessage.ShowWarning($@"Sản phẩm <{kH_XuatTHTH_CT.sDM_SanPham_Id_Ten}> đã nhập đủ so với kế hoạch");
                                return true;
                            }

                            //Lấy chi tiết phụ kiện theo kế hoạch
                            List<MT.Data.BO.KH_XuatTHTH_CT_PhuKien> kH_XuatTHTH_CT_PhuKiens = DBContext.GetRep2<Phieu_XuatTHTH_CT_PhuKienRepository>()
                                                                                                        .GetKH_XuatTHTH_CT_PhuKiensBysKH_XuatTHTH_CT_Id(kH_XuatTHTH_CT.Id);
                            List<MT.Data.BO.Phieu_XuatTHTH_CT_PhuKien> phieu_XuatTHTH_CT_PhuKiens = new List<Phieu_XuatTHTH_CT_PhuKien>();
                            if (kH_XuatTHTH_CT_PhuKiens != null)
                            {
                                foreach (var item in kH_XuatTHTH_CT_PhuKiens)
                                {
                                    phieu_XuatTHTH_CT_PhuKiens.Add(new Phieu_XuatTHTH_CT_PhuKien
                                    {
                                        Id = Guid.NewGuid(),
                            ...
                            phieu_XuatTHTH_CT.phieu_XuatTHTH_CT_PhuKiens = phieu_XuatTHTH_CT_PhuKiens;
                            phieu_XuatTHTH_CT.sKH_XuatTHTH_CT_Id = kH_XuatTHTH_CT.Id;
                            phieu_XuatTHTH_CT.sKH_XuatTHTH_Id = sKH_XuatTHTH_Id;
                            phieu_XuatTHTH_CT.sDM_SanPham_Id = kH_XuatTHTH_CT.sDM_SanPham_Id;
                            phieu_XuatTHTH_CT.sDM_DonViTinh_Id = kH_XuatTHTH_CT.sDM_DonViTinh_Id;
                            phieu_XuatTHTH_CT.rDonGia = kH_XuatTHTH_CT.rDonGia;
                            phieu_XuatTHTH_CT.rThanhTien = kH_XuatTHTH_CT.rDonGia;
                            //phieu_XuatTHTH_CT.sDM_MangLienLac_Id = kH_XuatTHTH_CT.sDM_MangLienLac_Id;
                            //phieu_XuatTHTH_CT.sDM_MangLienLac_Id_Ten = kH_XuatTHTH_CT.sDM_MangLienLac_Id_Ten;
                            phieu_XuatTHTH_CT.sDM_SanPham_Id_Ten = kH_XuatTHTH_CT.sDM_SanPham_Id_Ten;

                            /*phieu_XuatTHTH_CT.iThoiGianBaoHanh = kH_XuatTHTH_CT.iThoiGianBaoHanh;
                            phieu_XuatTHTH_CT.iDonViThoiGianBaoHanh = kH_XuatTHTH_CT.iDonViThoiGianBaoHanh;
                            phieu_XuatTHTH_CT.dHanBaoHanhDen = kH_XuatTHTH_CT.dHanBaoHanhDen;
                            phieu_XuatTHTH_CT.iNamSX = kH_XuatTHTH_CT.iNamSX;*/
                            phieu_XuatTHTH_CT.sXuatXu = kH_XuatTHTH_CT.sXuatXu;
                            phieu_XuatTHTH_CT.sGhiChu = kH_XuatTHTH_CT.sGhiChu;
                        }
                        else
                        {
                            ...
                            if (dm_SanPhams?.Count > 0)
                            {
                                ...
                                phieu_XuatTHTH_CT.sDM_SanPham_Id = dM_SanPham.Id;
                                phieu_XuatTHTH_CT.sDM_DonViTinh_Id = dM_SanPham.sDM_DonViTinh_Id_Cap1;
                                phieu_XuatTHTH_CT.rDonGia = dM_SanPham.rDonGia_Cap1;
                                phieu_XuatTHTH_CT.rThanhTien = dM_SanPham.rDonGia_Cap1;
                                phieu_XuatTHTH_CT.sDM_SanPham_Id_Ten = dM_SanPham.sTenSanPham;
                                ...
                                phieu_XuatTHTH_CT.sKH_XuatTHTH_CT_Id = null;
                                phieu_XuatTHTH_CT.sKH_XuatTHTH_Id = null;
                            }
                        }

                        phieu_XuatTHTH_CT.IsLoaded = true;
                        phieu_XuatTHTH_CT.rSoLuong = 1;
                        phieu_XuatTHTH_CT.sSerial = sSerial;
                        phieu_XuatTHTH_CT.sSTTSP = string.Empty;
                    }
                    else // Trường hợp xuất trả về sau khi mượn
                    {
                        if (sKH_XuatTHTH_Id.HasValue)
                        {
                            Phieu_NhapTHTH_CT phieu_NhapTHTH_CT = DBContext.GetRep2<Phieu_NhapTHTH_CTRepository>()
                                                               .GetPhieu_NhapTHTH_CTBysPhieu_NhapTHTH_IdAndsMaSP(sKH_XuatTHTH_Id, sMaSP);
                            if (phieu_NhapTHTH_CT == null)
                            {
                                MMessage.ShowWarning($@"Phiếu nhập <{cbossKH_XuatTHTH_Id_CanCu.Text}> không tồn tại sản phẩm <{sMaSP}>");
                                return true;
                            }

                            //Lấy chi tiết phụ kiện theo kế hoạch
                            List<MT.Data.BO.Phieu_NhapTHTH_CT_PhuKien> phieu_NhapTHTH_CT_PhuKiens = DBContext.GetRep2<Phieu_NhapTHTH_CT_PhuKienRepository>()
                                                                                                        .GetPhieu_NhapTHTH_CT_PhuKiensBysPhieu_NhapTHTH_CT_Id(phieu_NhapTHTH_CT.Id);
                            List<MT.Data.BO.Phieu_XuatTHTH_CT_PhuKien> phieu_XuatTHTH_CT_PhuKiens = new List<Phieu_XuatTHTH_CT_PhuKien>();
                            if (phieu_NhapTHTH_CT_PhuKiens != null)
                            {
                                foreach (var item in phieu_NhapTHTH_CT_PhuKiens)
                                {
                                    phieu_XuatTHTH_CT_PhuKiens.Add(new Phieu_XuatTHTH_CT_PhuKien
                                    {
                                        Id = Guid.NewGuid(),
                            ...
                            phieu_XuatTHTH_CT.phieu_XuatTHTH_CT_PhuKiens = phieu_XuatTHTH_CT_PhuKiens;
                            phieu_XuatTHTH_CT.sKH_XuatTHTH_CT_Id = phieu_NhapTHTH_CT.Id;
                            phieu_XuatTHTH_CT.sKH_XuatTHTH_Id = sKH_XuatTHTH_Id;
                            phieu_XuatTHTH_CT.sDM_SanPham_Id = phieu_NhapTHTH_CT.sDM_SanPham_Id;
                            phieu_XuatTHTH_CT.sDM_DonViTinh_Id = phieu_NhapTHTH_CT.sDM_DonViTinh_Id;
                            phieu_XuatTHTH_CT.rDonGia = phieu_NhapTHTH_CT.rDonGia;
                            phieu_XuatTHTH_CT.rThanhTien = phieu_NhapTHTH_CT.rDonGia;
                            phieu_XuatTHTH_CT.sDM_SanPham_Id_Ten = phieu_NhapTHTH_CT.sDM_SanPham_Id_Ten;
                            //phieu_XuatTHTH_CT.sDM_MangLienLac_Id = phieu_NhapTHTH_CT.sDM_MangLienLac_Id;
                            //phieu_XuatTHTH_CT.sDM_MangLienLac_Id_Ten = phieu_NhapTHTH_CT.sDM_MangLienLac_Id_Ten;

                            /*phieu_XuatTHTH_CT.iThoiGianBaoHanh = phieu_NhapTHTH_CT.iThoiGianBaoHanh;
                            phieu_XuatTHTH_CT.iDonViThoiGianBaoHanh = phieu_NhapTHTH_CT.iDonViThoiGianBaoHanh;
                            phieu_XuatTHTH_CT.dHanBaoHanhDen = phieu_NhapTHTH_CT.dHanBaoHanhDen;
                            phieu_XuatTHTH_CT.iNamSX = phieu_NhapTHTH_CT.iNamSX;*/
                            phieu_XuatTHTH_CT.sXuatXu = phieu_NhapTHTH_CT.sXuatXu;
                            phieu_XuatTHTH_CT.sGhiChu = phieu_NhapTHTH_CT.sGhiChu;
                            phieu_XuatTHTH_CT.sSTTSP = phieu_NhapTHTH_CT.sSTTSP;
                        }
                        else
                        {
                            var dm_SanPhams = DBContext.GetRep<MT.Data.Rep.DM_SanPhamRepository>().GetData(typeof(MT.Data.BO.DM_SanPham), where: $"sMaSanPham='{sMaSP}'");
                    ...
                    // Check kẹp chì
                    string tenSP = "";
                    bool isKepChi = DBContext.GetRep2<MT.Data.Rep.Phieu_XuatTHTHRepository>()
                                                                   .KiemTraKepChi((int)cboEnumiLoaiTCXuat.GetValue(), new List<object> { phieu_XuatTHTH_CT }, out tenSP);

                    if (!isKepChi)
                    {
                        MMessage.ShowWarning($"Sản phẩm <{tenSP}>  là sản phẩm kẹp chì. Bạn không được phép tiêu hủy");
                        //return true;
                    }
                    // Truong 2022
                    ...
                    if (dm_Phieu_NhapSanPhamMois != null && dm_Phieu_NhapSanPhamMois.Count == 1)
                    {
                        ...
                        phieu_XuatTHTH_CT.iThoiGianBaoHanh = curPNM.iThoiGianBaoHanh;
                        phieu_XuatTHTH_CT.iDonViThoiGianBaoHanh = curPNM.iDonViThoiGianBaoHanh;
                        phieu_XuatTHTH_CT.iNamSX = curPNM.iNamSX;
                        phieu_XuatTHTH_CT.dHanBaoHanhDen = curPNM.dHanBaoHanhDen;
                    }
        ...
        private bool grdSanPham_ValidEditValueChanging(DevExpress.XtraGrid.Columns.GridColumn gridColumn, ChangingEventArgs e)
        {
            /*if (cbossKH_XuatTHTH_Id_CanCu.EditValue == null)
            {
                ActiveControl = cbossKH_XuatTHTH_Id_CanCu;
            ...
            if (gridColumn.FieldName == "sSTTSP" && e.NewValue != null && !object.Equals(e.OldValue, e.NewValue))
            {
                ...
                Phieu_XuatTHTH_CT phieu_XuatTHTH = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_XuatTHTH_CT>();
                if (arrSerial.Length > 0 && (decimal)arrSerial.Length > phieu_XuatTHTH.rSoLuong)
                {
                    e.NewValue = string.Empty;
                    MMessage.ShowWarning($"Bạn chỉ được phép chọn tối đa {(int)phieu_XuatTHTH.rSoLuong} số serial");
                    return false;
                }
            }
            // truong
            /*if (gridColumn.FieldName == "sMaVach" && e.NewValue != null && !object.Equals(e.OldValue, e.NewValue))
            {
                ...
                MT.Data.BO.SoKho findInSoKho = soKho.Find(m => m.sMaVach.Equals(e.NewValue.ToString()) && (m.iLoaiPhieu.Equals((int)iLoaiPhieu.NhapMoi) || m.iLoaiPhieu.Equals((int)iLoaiPhieu.NhapMuon))); // 12: Phiếu nhập mới
                if (findInSoKho == null)
                {
                    e.NewValue = string.Empty;
        ...
        {
            Phieu_XuatTHTH_CT phieu_XuatTHTH_CT = (Phieu_XuatTHTH_CT)newRecord;
            if (phieu_XuatTHTH_CT.sDM_SanPham_Id.HasValue
                && !phieu_XuatTHTH_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                if (cbossKH_XuatTHTH_Id_CanCu.EditValue == null)
                {
                    ActiveControl = cbossKH_XuatTHTH_Id_CanCu;
                ...
                Guid sKH_XuatTHTH_Id_CanCu = Guid.Parse(cbossKH_XuatTHTH_Id_CanCu.EditValue.ToString());

                //Có sản phẩm thì lấy giá trị mặc định
                var kH_XuatTHTH_CT = GetKH_XuatTHTH_CTByIdAndsDM_SanPham_Id(sKH_XuatTHTH_Id_CanCu,
                    phieu_XuatTHTH_CT.sDM_SanPham_Id.Value, phieu_XuatTHTH_CT);

                if (kH_XuatTHTH_CT != null)
                {
                    phieu_XuatTHTH_CT.sDM_SanPham_Id_Ten = kH_XuatTHTH_CT.sDM_SanPham_Id_Ten;
                    phieu_XuatTHTH_CT.sDM_DonViTinh_Id = kH_XuatTHTH_CT.sDM_DonViTinh_Id;
                    phieu_XuatTHTH_CT.rSoLuong = kH_XuatTHTH_CT.rSoLuong;
                    phieu_XuatTHTH_CT.rDonGia = kH_XuatTHTH_CT.rDonGia;
                    phieu_XuatTHTH_CT.rThanhTien = kH_XuatTHTH_CT.rSoLuong * kH_XuatTHTH_CT.rDonGia;

                    phieu_XuatTHTH_CT.sSerial = string.Empty;
                    phieu_XuatTHTH_CT.iThoiGianBaoHanh = 60;
                    phieu_XuatTHTH_CT.iDonViThoiGianBaoHanh = (int)MT.Data.iDonViThoiGianHieuLuc.Ngay;
                    phieu_XuatTHTH_CT.sCauHinhKyThuat = kH_XuatTHTH_CT.sCauHinhKyThuat;
                    phieu_XuatTHTH_CT.sXuatXu = kH_XuatTHTH_CT.sXuatXu;
                    phieu_XuatTHTH_CT.iNamSX = kH_XuatTHTH_CT.iNamSX;
                    phieu_XuatTHTH_CT.sKH_XuatTHTH_CT_Id = kH_XuatTHTH_CT.Id;
                    phieu_XuatTHTH_CT.dHanBaoHanhDen = SysDateTime.Instance.Now().AddDays(60);
                }
            }
            return true;
        }
        ...
        /// </summary>
        /// <param name="sKH_XuatTHTH_Id_CanCu">Căn cứ kế hoạch</param>
        /// <param name="sDM_SanPham_Id">Id sản phẩm</param>
        /// <param name="phieu_XuatTHTH_CT">Chi tiết sản phẩm nhập mới</param>
        /// <returns></returns>
        private KH_XuatTHTH_CT GetKH_XuatTHTH_CTByIdAndsDM_SanPham_Id(Guid sKH_XuatTHTH_Id_CanCu, Guid sDM_SanPham_Id, Phieu_XuatTHTH_CT phieu_XuatTHTH_CT)
        {
            List<Phieu_XuatTHTH_CT> phieu_XuatTHTH_CTs = grdSanPham.GrdDetail.GetAllData<Phieu_XuatTHTH_CT>();

            var H_XuatTHTH_CT = DBContext.GetRep2<KH_XuatTHTH_CTRepository>()
                .GetKH_XuatTHTH_CTBysKH_XuatTHTH_IdAndsDM_SanPham_Id(sKH_XuatTHTH_Id_CanCu,
                sDM_SanPham_Id, phieu_XuatTHTH_CT.sDM_DonViTinh_Id, phieu_XuatTHTH_CT.Id);
            decimal rSoluong = 0;
            if (phieu_XuatTHTH_CTs != null && phieu_XuatTHTH_CTs.Count > 0)
            {
                rSoluong = phieu_XuatTHTH_CTs.FindAll(m => m.sKH_XuatTHTH_CT_Id == H_XuatTHTH_CT.Id && m.Id != phieu_XuatTHTH_CT.Id).Sum(m => m.rSoLuong);
            }
            if (H_XuatTHTH_CT != null)
            {
                H_XuatTHTH_CT.rSoLuong = H_XuatTHTH_CT.rSoLuong - rSoluong;
                if (H_XuatTHTH_CT.rSoLuong <= 0)
                {
                    H_XuatTHTH_CT.rSoLuong = 0;
                }
                if (H_XuatTHTH_CT.IsShowSoSerial && H_XuatTHTH_CT.rSoLuong > H_XuatTHTH_CT.iKichThuocDongGoi)
                {
                    H_XuatTHTH_CT.rSoLuong = H_XuatTHTH_CT.iKichThuocDongGoi;
                }
                H_XuatTHTH_CT.rThanhTien = H_XuatTHTH_CT.rSoLuong * H_XuatTHTH_CT.rDonGia;
            }

            return H_XuatTHTH_CT;
        }
        ...
        private void ColsActionPhuKien_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            var phieu_XuatTHTH_CT = grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_XuatTHTH_CT>();
            if (phieu_XuatTHTH_CT.sDM_SanPham_Id.HasValue && !phieu_XuatTHTH_CT.sDM_SanPham_Id.Value.Equals(Guid.Empty))
            {
                //frmPhieu_XuatTHTH_CT_PhuKienDetail frmPhieu_XuatTHTH_CT_PhuKienDetail = new frmPhieu_XuatTHTH_CT_PhuKienDetail(grdSanPham.GrdDetail.GetRecordByRowSelected<Phieu_XuatTHTH_CT>());
                frmPhuKienDetail frmPhuKienDetail = new frmPhuKienDetail(phieu_XuatTHTH_CT.sDM_SanPham_Id.Value,
                    "Phieu_XuatTHTH_CT_PhuKien", "phieu_XuatTHTH_CT_PhuKiens", phieu_XuatTHTH_CT, this);
        ...
        protected override bool IsValidateDataChangedGridDetail(MGridEditable mGridEditable, System.Collections.IList dataChanged)
        {
            ...
            {
                List<MT.Data.BO.Phieu_XuatTHTH_CT> phieu_XuatTHTH_CTs = mGridEditable.GrdDetail.GetAllData<MT.Data.BO.Phieu_XuatTHTH_CT>();

                foreach (var item in dataChanged)
                {
                    var castItem = (MT.Data.BO.Phieu_XuatTHTH_CT)item;
                    ...
                    if (isValid && phieu_XuatTHTH_CTs != null && phieu_XuatTHTH_CTs.Count > 0)
                    {
                        //Kiểm tra mã vạch có bị trùng hay không
                        MT.Data.BO.Phieu_XuatTHTH_CT findBysMaVach = phieu_XuatTHTH_CTs.Find(m => m.sMaVach.Equals(castItem.sMaVach) && m.Id != castItem.Id);
                        ...
                        /*else
                        {
                            ...
                            // Kiểm tra tiếp xem mã vạch có tồn tại trong SoKho hay không
                            MT.Data.BO.SoKho findInSoKho = soKho.Find(m => m.sMaVach.Equals(castItem.sMaVach) && (m.iLoaiPhieu.Equals((int)iLoaiPhieu.NhapMoi) || m.iLoaiPhieu.Equals((int)iLoaiPhieu.NhapMuon))); // 12: Phiếu nhập mới|| Nhập mượn
                            if (findInSoKho == null)
                            {
                                isValid = false;
                                mGridEditable.GrdDetail.FirstView.FocusedColumn = mGridEditable.GrdDetail.FirstView.Columns["sMaVach"];
        ...
        protected override void CustomRowCellGridDetail(MGridControl mGridControl, RepositoryItem repository, CustomRowCellEditEventArgs e)
        {
            ...
            switch (mGridControl.TableName)
            {
                case "Phieu_XuatTHTH_CT":
                    ...
                    {
                        //MT.Data.BO.Phieu_XuatTHTH curMaster = (MT.Data.BO.Phieu_XuatTHTH)this.CurrentData;
        ...
        protected override void CustomRowCellValueChangedGridDetail(MGridControl mGridControl, CellValueChangedEventArgs e)
        {
            ...
            {
                case "Phieu_XuatTHTH_CT":
                    Phieu_XuatTHTH_CT phieu_XuatTHTH_CT = mGridControl.GetRecordByRowSelected<Phieu_XuatTHTH_CT>();
                    if (e.Column.FieldName == "sDM_SanPham_Id")
                    {
                        //gán mặc định đơn vị tính cấp 1 cho sản phẩm
                        if (mGridControl.FuncCustomRecordBeforeAddRow != null)
                        {
                            mGridControl.FuncCustomRecordBeforeAddRow(phieu_XuatTHTH_CT, mGridControl);
                        }
                    }
                    // Noteeeeeeeee
                    //if (e.Column.FieldName == "sDM_SanPham_Id")
                    ...
                    {
                        phieu_XuatTHTH_CT.rThanhTien = phieu_XuatTHTH_CT.rSoLuong * phieu_XuatTHTH_CT.rDonGia;
                        //phieu_XuatTHTH_CT = mGridControl.GetRecordByRowSelected<Phieu_XuatTHTH_CT>();
                        //mGridControl.FirstView.SetRowCellValue(e.RowHandle, "rThanhTien", phieu_XuatTHTH_CT.rSoLuong * phieu_XuatTHTH_CT.rDonGia);
                    }
                    if (e.Column.FieldName == "sSTTSP")
                    {
                        ...
                        if (objsSTTSP != null)
                        {
                            ...
                            {
                                phieu_XuatTHTH_CT.rSoLuong = arrSerial.Length;
                            }
                        }
                    }
                    ...
                    if (e.Column.FieldName == "iThoiGianBaoHanh" || e.Column.FieldName == "iDonViThoiGianBaoHanh")
                    {
                        ...
                        switch (phieu_XuatTHTH_CT.iDonViThoiGianBaoHanh)
                        {
                            case (int)MT.Data.iDonViThoiGianHieuLuc.Ngay:
                                dHanBaoHanhDen = now.AddDays(phieu_XuatTHTH_CT.iThoiGianBaoHanh).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Thang:
                                dHanBaoHanhDen = now.AddMonths(phieu_XuatTHTH_CT.iThoiGianBaoHanh).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Quy:
                                dHanBaoHanhDen = now.AddYears(phieu_XuatTHTH_CT.iThoiGianBaoHanh * 3).AddDays(1);
                                break;

                            case (int)MT.Data.iDonViThoiGianHieuLuc.Nam:
                                dHanBaoHanhDen = now.AddYears(phieu_XuatTHTH_CT.iThoiGianBaoHanh).AddDays(1);
                                break;
                        }
                        phieu_XuatTHTH_CT.dHanBaoHanhDen = dHanBaoHanhDen;
                    }
                    break;
            }
        }
        ...
        protected override void SetViewModeControlByFromAction()
        {
            ...
            switch (this.FormAction)
            {
                ...
                case (int)MTControl.FormAction.Duplicate:
                    cbossKH_XuatTHTH_Id_CanCu.SetReadOnly(false);
                    break;

                default:
                    cbossKH_XuatTHTH_Id_CanCu.SetReadOnly(true);
                    break;
            }
        ...
        {
            var currentData = (Phieu_XuatTHTH)base.PrepareDataBeforeBindDataForm();
            switch (this.FormAction)
            {
                case (int)MTControl.FormAction.Add:
                case (int)MTControl.FormAction.Duplicate:
                    ...
                    currentData.sKH_XuatTHTH_Id_CanCu = null;
        ...
        private void cbosDM_KeHoachXuat_EditValueChanged(object sender, EventArgs e)
        {
            switch (this.FormAction)//cbosDM_KeHoachXuat
            {
                ...
                case (int)MTControl.FormAction.Duplicate:
                    if (cboEnumiLoaiTCXuat.SelectedIndex == 0)
                    {
                        MT.Data.BO.KH_XuatTHTH kH_XuatTHTH = cbossKH_XuatTHTH_Id_CanCu.GetRecordSelected<MT.Data.BO.KH_XuatTHTH>();
                        if (kH_XuatTHTH != null)
                        {
                            cbosDM_CanBo_Id_NguoiNhap.SetReadOnly(false);
                            cbosDM_CanBo_Id_NguoiGiao.SetReadOnly(false);
                            treesDM_DonVi_Id_DonViNhap.SetReadOnly(false);

                            // Thiết lập giá trị mặc định cho đơn vị xuất
                            Guid maDVXuat = kH_XuatTHTH.sDM_DonVi_Id_DonViXuat;
                            treesDM_DonVi_Id_DonViXuat.SetValue(maDVXuat);

                            // Thiết lập giá trị mặc định cho đơn vị nhập
                            Guid maDVNhap = kH_XuatTHTH.sDM_DonVi_Id_DonViNhap;
                            ...
                            if (sDM_Donvi_Id_nhan != null)
                            {
                                cbosDM_CanBo_Id_NguoiNhap.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.DM_CanBoRepository>().GetData(typeof(MT.Data.BO.DM_CanBo),
                                   ...
                                   orderBy: "sMaCanBo",
                                   viewName: "View_DM_CanBo");
                                //var datas = DBContext.GetRep2<Phieu_XuatTHTH_CTRepository>().GetKHXuatTHTH_CTsByMasterId(kH_XuatTHTH.Id);
                    ...
                    {
                        MT.Data.BO.Phieu_NhapTHTH phieu_NhapTHTH = cbossKH_XuatTHTH_Id_CanCu.GetRecordSelected<MT.Data.BO.Phieu_NhapTHTH>();
                        if (phieu_NhapTHTH != null)
                        {
                            // Thiết lập giá trị mặc định cho đơn vị xuất
                            Guid maDVXuat = phieu_NhapTHTH.sDM_DonVi_Id_Xuat;
                            // Thiết lập giá trị mặc định cho đơn vị nhập
                            Guid maDVNhap = phieu_NhapTHTH.sDM_DonVi_Id_Nhap;

                            treesDM_DonVi_Id_DonViNhap.SetValue(maDVNhap);
                            treesDM_DonVi_Id_DonViXuat.SetValue(maDVNhap);

                            //cbosDM_CanBo_Id_NguoiNhap.Enabled = false;
                            cbosDM_CanBo_Id_NguoiNhap.EditValue = cbosDM_CanBo_Id_NguoiGiao.EditValue;
                            cbosDM_CanBo_Id_NguoiNhap.SetReadOnly(true);
                            cbosDM_CanBo_Id_NguoiNhap.IsRequired = false;
                            cbosDM_CanBo_Id_NguoiGiao.SetReadOnly(true);
                            cbosDM_CanBo_Id_NguoiGiao.IsRequired = false;
                            treesDM_DonVi_Id_DonViNhap.SetReadOnly(true);
                            treesDM_DonVi_Id_DonViNhap.IsRequired = false;
                            //object sDM_Donvi_Id_nhan = treesDM_DonVi_Id_DonViNhap.GetValue();
        ...
        // 14.6
        private void cbossKH_XuatTHTH_Id_CanCu_QueryPopUp(object sender, CancelEventArgs e)
        {
            if (cboEnumiLoaiTCXuat.SelectedIndex == 1)
            {
                cbossKH_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_NhapTHTHRepository>().GetData(typeof(MT.Data.BO.Phieu_NhapTHTH),
                ...
                orderBy: "sSo DESC", viewName: "View_Phieu_NhapTHTH");
                linkFormVoucher.VoucherId = null;
                linkFormVoucher.ControlVoucher = cbossKH_XuatTHTH_Id_CanCu;
                linkFormVoucher.TableName = "Phieu_NhapTHTH";
            }
            else
            {
                cbossKH_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.KH_XuatTHTHRepository>().GetData(typeof(MT.Data.BO.KH_XuatTHTH),
        ...
        private void cboEnumiLoaiTCXuat_EditValueChanged(object sender, EventArgs e)
        {
            ...
            cbossKH_XuatTHTH_Id_CanCu.CleadAllColumn();
            if (cboEnumiLoaiTCXuat.SelectedIndex == 1)
            {
                cbossKH_XuatTHTH_Id_CanCu.Properties.DisplayMember = "sMa";
                cbossKH_XuatTHTH_Id_CanCu.Properties.ValueMember = "Id";
                cbossKH_XuatTHTH_Id_CanCu.AddColumn("sMa", "Số phiếu nhập", 120);
                cbossKH_XuatTHTH_Id_CanCu.AddColumn("dNgayPhieu_Nhap", "Ngày lập", 80);
                cbossKH_XuatTHTH_Id_CanCu.AddColumn("sDM_DonVi_Id_Xuat_Ten", "Đơn vị lập", 120);
                //cbossKH_XuatTHTH_Id_CanCu.AddColumn("iThoiGianHieuLuc", "Thời gian hiệu lực", 120, true);
                cbossKH_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.Phieu_NhapTHTHRepository>().GetData(typeof(MT.Data.BO.Phieu_NhapTHTH),
                    columns: "Id,sMa,dNgayPhieu_Nhap,sDM_DonVi_Id_Xuat_Ten, sDM_DonVi_Id_Nhap, sDM_DonVi_Id_Xuat",
                    where: $"sDM_DonVi_Id_Nhap ='{MT.Library.SessionData.OrganizationUnitId}' AND iTrangThaiThucHien < {(int)MT.Data.iTrangThaiThucHienKHNM.DaHoanThanh}",
            ...
            else
            {
                cbossKH_XuatTHTH_Id_CanCu.Properties.DisplayMember = "sMa";
                cbossKH_XuatTHTH_Id_CanCu.Properties.ValueMember = "Id";
                cbossKH_XuatTHTH_Id_CanCu.AddColumn("sMa", "Số kế hoạch", 120);
                cbossKH_XuatTHTH_Id_CanCu.AddColumn("dNgayKeHoach", "Ngày lập", 80);
                cbossKH_XuatTHTH_Id_CanCu.AddColumn("sDM_DonVi_Id_DonViXuat_Ten", "Đơn vị xuất", 120);
                //cbossKH_XuatTHTH_Id_CanCu.AddColumn("iThoiGianHieuLuc", "Thời gian hiệu lực", 120, true);
                cbossKH_XuatTHTH_Id_CanCu.Properties.DataSource = DBContext.GetRep<MT.Data.Rep.KH_XuatTHTHRepository>().GetData(typeof(MT.Data.BO.KH_XuatTHTH),
                    columns: "Id,sMa,dNgayKeHoach,sDM_DonVi_Id_DonViXayDungKH_Ten,sDM_DonVi_Id_DonViXuat_Ten, sDM_DonVi_Id_DonViXuat, sDM_DonVi_Id_DonViNhap",
                    where: $"iTrangThaiDuyet=1 AND iTrangThaiThucHienKHNM < {(int)MT.Data.iTrangThaiThucHienKHNM.DaHoanThanh} AND sDM_DonVi_Id_DonViXuat ='{MT.Library.SessionData.OrganizationUnitId}'",
