...
namespace FormUI
{
    public partial class frmPhieu_NhapSanPhamMoi : FormUI.MFormList
    {
        #region"Property"
        ...
        public frmPhieu_NhapSanPhamMoi()
        {
            ...
            this.ControlTepDinhKem = ucTepDinhKemList;
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_NhapSanPhamMoiRepository)ConfigFormDetail.Rep).GetViewPaging();
            this.gridMaster.KeyName = "Id";
            grd.Sumary = "rThanhTien";
            grd.IsShowFilter = true;
            grd.CustomModelFields = "sDM_CanBo_Id_NguoiDuyet";
            this.gridMaster.AddColumnText("sMa", "Số phiếu", "Số phiếu", 120, isFixWidth: true,
                fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("dNgayPhieu_NhapSanPhamMoi", "Ngày phiếu", 100);
            this.gridMaster.AddColumnText("sMa_KH", "Số KH","Số kế hoạch", 120);
            this.gridMaster.AddColumnText("sDM_DonVi_Id_Nhap_Ten", "Đơn vị nhập", "Đơn vị nhập", 180);
            this.gridMaster.AddColumnText("sDM_CanBo_Id_NguoiNhap_Ten", "Người nhập", "Người nhập", 150);
            this.gridMaster.AddColumnText("sDM_CanBo_Id_NguoiLapPhieu_Ten", "Người lập", 150);
            this.gridMaster.AddColumnText("sDM_CanBo_Id_NguoiDuyet_Ten", "Người duyệt", "Người duyệt", 180);
            this.gridMaster.AddColumnText("dNgayDuyet", "Ngày duyệt", 80);
            var colMaster=this.gridMaster.AddColumnText("iNhapVeKho", "Hình thức nhập", "Hình thức nhập", 180, enumName: "iNhapVeKho");
            this.gridMaster.AddColumnText("sGhiChu", "Ghi chú", 200);
            colMaster= this.gridMaster.AddColumnText("rThanhTien", "Tổng tiền", 150,
            ...
            this.gridMaster.AddColumnText("iTrangThaiDuyet", "Trạng thái duyệt", 100,
                fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Right, enumName: "iTrangThaiDuyetPNM");

            //Sản phẩm
            grdSanPham.TableName = "Phieu_NhapSanPhamMoi_CT";
            grdSanPham.ViewName = "View_Phieu_NhapSanPhamMoi_CT";
            ...
            grdPhuKienDetail.TableName = "Phieu_NhapSanPhamMoi_CT_PhuKien";
            grdPhuKienDetail.TableName = "View_Phieu_NhapSanPhamMoi_CT_PhuKien";
        ...
        bool CheckPermissionAproveOrReject(MT.Data.iTrangThaiDuyetPNM iTrangThaiDuyetPNM)
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapSanPhamMoi>();

            if (datas == null || datas.Count == 0)
            {
                MMessage.ShowWarning("Bạn phải chọn ít nhất 1 phiếu nhập mới.");
                return false;
            }
            string msg = "Phê duyệt";
            if (iTrangThaiDuyetPNM == MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet)
            {
                msg = "Từ chối";
            }
            ...
            foreach (var item in datas)
            {
                ...
                {
                    MMessage.ShowWarning($"Bạn không có quyền {msg} với phiếu nhập mới <{item.sMa}>.");
                    return false;
                }
            }
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapSanPhamMoi>();
                        ...
                        var frmPhieuNhapSanPhamMoi_PheDuyet = new frmPhieu_NhapSanPhamMoi_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.DongYDuyet, datasApprove);
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapSanPhamMoi>();
                        ...
                        var frmKH_NhapSanPhamMoi_TuChoi = new frmPhieu_NhapSanPhamMoi_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet, datasReject);
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_NhapSanPhamMoi_CT")
            {
        ...
        private void LoadMasterData(object sender, EventArgs e)
        {
            try
            {
                ...
                PagingList.SetWhere($@" dNgayPhieu_NhapSanPhamMoi BETWEEN '{drKyBaoCao.FromDate.Value.StartDate()}' 
        ...
        #region"Event"
        private void frmPhieu_NhapSanPhamMoi_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_NhapSanPhamMoi_CTRepository>().GetDetailsByMasterID2("View_Phieu_NhapSanPhamMoi_CT_PhuKien",
                        "Phieu_NhapSanPhamMoi_CT_PhuKien", e.Argument);
            }
            finally
            {
