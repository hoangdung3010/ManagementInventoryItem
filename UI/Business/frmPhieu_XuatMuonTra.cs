...
namespace FormUI
{
    public partial class frmPhieu_XuatMuonTra : FormUI.MFormList
    {
        #region"Property"
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_XuatMuonTraRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            //this.gridMaster.AddColumnText("sMaPhieu_XuatMuonTra", "Mã phiếu xuất","Mã phiếu xuất", 180,isFixWidth:true,fixedStyle:DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("dNgayPhieu_Xuat", "Ngày phiếu", 100);
            //this.gridMaster.AddColumnText("sKH_XuatMuonTra_Id_CanCu", "Kế hoạch xuất", 150,fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            ...
            colMaster.FilterEditor = new ConfigFilterEditor { DataType = DataTypeColumn.ComboBox };
            //Sản phẩm
            grdSanPham.TableName = "Phieu_XuatMuonTra_CT";
            grdSanPham.ViewName = "View_Phieu_XuatMuonTra_CT";
            ...
            grdPhuKienDetail.TableName = "Phieu_XuatMuonTra_CT_PhuKien";
            grdPhuKienDetail.ViewName = "View_Phieu_XuatMuonTra_CT_PhuKien";
        ...
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatMuonTra>();
            ...
            foreach (var item in datas)
            {
                ...
                List<string> pHXuatSP_sMas = DBContext.GetRep2<Phieu_XuatMuonTraRepository>().GetPhieuNhapsByPhX(item.Id);
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                ...
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatMuonTra>();
                        ...
                        var frmPhieu_XuatMuonTra_PheDuyet = new frmPhieu_XuatMuonTra_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.DongYDuyet, datasApprove);
                        frmPhieu_XuatMuonTra_PheDuyet.ShowDialog();
                        frmPhieu_XuatMuonTra_PheDuyet.Dispose();
                    }
                    break;
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatMuonTra>();
                        ...
                        var frmPhieu_XuatMuonTra_TuChoi = new frmPhieu_XuatMuonTra_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet, datasReject);
                        frmPhieu_XuatMuonTra_TuChoi.ShowDialog();
                        frmPhieu_XuatMuonTra_TuChoi.Dispose();
                    }
                    break;
            }
        }
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_XuatMuonTra_CT")
            {
        ...
        private void frmPhieu_XuatMuonTra_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_XuatMuonTra_CTRepository>().GetDetailsByMasterID2("View_Phieu_XuatMuonTra_CT_PhuKien",
                        "Phieu_XuatMuonTra_CT_PhuKien", e.Argument);
            }
            finally
            {
