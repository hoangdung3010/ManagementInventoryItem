...
namespace FormUI
{
    public partial class frmPhieu_NhapMuonTra : FormUI.MFormList
    {
        #region"Property"
        ...
        {
            cboEnumiLoaiTCNhap.ItemEnum.Add(-1, "Tất cả");
            cboEnumiLoaiTCNhap.DefaultValueEnum = -1;
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_NhapMuonTraRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            this.gridMaster.AddColumnText("sMa", "Số phiếu", "Số phiếu", 120, isFixWidth: true, fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("soPX", "Căn cứ phiếu xuất", "Căn cứ phiếu xuất", 120, isFixWidth: true);
            //this.gridMaster.AddColumnText("sMaPhieu_NhapMuonTra", "Mã phiếu xuất","Mã phiếu xuất", 180,isFixWidth:true,fixedStyle:DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("dNgayPhieu_Nhap", "Ngày lập phiếu", 100);
            //this.gridMaster.AddColumnText("sKH_NhapMuonTra_Id_CanCu", "Kế hoạch xuất", 150,fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            ...
            colMaster = this.gridMaster.AddColumnText("sDM_CanBo_Id_NguoiGiao_Ten", "Người giao", "Người giao", 150);
            ...
            this.gridMaster.AddColumnText("sGhiChu", "Ghi chú", 200);
            //this.gridMaster.AddColumn(n)
            //Sản phẩm
            grdSanPham.TableName = "Phieu_NhapMuonTra_CT";
            grdSanPham.ViewName = "View_Phieu_NhapMuonTra_CT";
            ...
            grdPhuKienDetail.TableName = "Phieu_NhapMuonTra_CT_PhuKien";
            grdPhuKienDetail.ViewName = "View_Phieu_NhapMuonTra_CT_PhuKien";
        ...
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapMuonTra>();
            ...
            foreach (var item in datas)
            {
                ...
                {
                    MMessage.ShowWarning($"Bạn không có quyền {msg} với phiếu nhập sản phẩm <{item.sMa}>.");
                    return false;
                }

                // KIỂM TRA XEM PHIẾU NHẬP NÀY ĐƯỢC SỬ DỤNG Ở NHỮNG NƠI NÀO? --> Tạm bỏ qua chỗ này
                //List<string> pHXuatSP_sMas = DBContext.GetRep2<Phieu_NhapMuonTraRepository>().GetPhieuXuatsByKHX(item.Id);
                //if (pHXuatSP_sMas.Count > 0)
                //{
                //    MMessage.ShowWarning($"Bạn không được phép {msg}. Do phiếu sản phẩm <{item.sMa}> đã phát sinh các phiếu nhập <{string.Join(", ", pHXuatSP_sMas)}>.");
                //    return false;
                //}
            }
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                ...
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapMuonTra>();
                        ...
                        var frmPhieu_NhapMuonTra_PheDuyet = new frmPhieu_NhapMuonTra_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.DongYDuyet, datasApprove);
                        frmPhieu_NhapMuonTra_PheDuyet.ShowDialog();
                        frmPhieu_NhapMuonTra_PheDuyet.Dispose();
                    }
                    break;
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_NhapMuonTra>();
                        ...
                        var frmPhieu_NhapMuonTra_TuChoi = new frmPhieu_NhapMuonTra_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet, datasReject);
                        frmPhieu_NhapMuonTra_TuChoi.ShowDialog();
                        frmPhieu_NhapMuonTra_TuChoi.Dispose();
                    }
                    break;
            }
        }
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_NhapMuonTra_CT")
            {
        ...
        private void LoadMasterData(object sender, EventArgs e)
        {
            try
            {
                ...
                PagingList.SetWhere($@" dNgayPhieu_Nhap BETWEEN '{drKyBaoCao.FromDate.Value.StartDate()}'
                                    ...
                                    AND (iTCNhap={cboEnumiLoaiTCNhap.GetValue()} OR {cboEnumiLoaiTCNhap.GetValue()}<=-1) ");
                RefreshData();
            }
            catch (Exception ex)
            {
        ...
        private void frmPhieu_NhapMuonTra_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_NhapMuonTra_CTRepository>().GetDetailsByMasterID2("View_Phieu_NhapMuonTra_CT_PhuKien",
                        "Phieu_NhapMuonTra_CT_PhuKien", e.Argument);
            }
            finally
            {
        ...
        private void cboEnumiLoaiTCNhap_EditValueChanged_1(object sender, EventArgs e)
        {
            if (isLoaded)
                LoadMasterData(sender, e);
        }
