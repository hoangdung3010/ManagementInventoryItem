...
namespace FormUI
{
    public partial class frmPhieu_NhapCaiDatSanPham_PheDuyet : FormUI.FormUIBase
    {
        IList Phieu_NhapCaiDatSanPhams;

        int iTrangThai;

        Action callback;
        public frmPhieu_NhapCaiDatSanPham_PheDuyet(Action callback, int iTrangThai,
            IList Phieu_NhapCaiDatSanPhams)
        {
            InitializeComponent();
            this.Phieu_NhapCaiDatSanPhams = Phieu_NhapCaiDatSanPhams;
            ...
            if (this.Phieu_NhapCaiDatSanPhams.Count == 1)
            {
                txtsLyDoDuyet.EditValue = this.Phieu_NhapCaiDatSanPhams[0].GetValue<string>("sLyDoXetDuyet");
            }
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = "View_Phieu_NhapCaiDatSanPham";
            grd.AddColumnText("sMa", "Số phiếu", "Số phiếu", 120, isFixWidth: true,
                fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            grd.AddColumnText("dNgayPhieu_Nhap", "Ngày phiếu", 100);
            grd.AddColumnText("sMa_PX", "Căn cứ số PX", "Căn cứ số", 120);
            grd.AddColumnText("sDM_DonVi_Id_Nhap_Ten", "Đơn vị nhập", "Đơn vị nhập", 180);
            grd.AddColumnText("sDM_DonVi_Id_Xuat_Ten", "Đơn vị xuất", "Đơn vị xuất", 180);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                Phieu_NhapCaiDatSanPhamRepository Phieu_NhapCaiDatSanPhamRep = DBContext.GetRep2<Phieu_NhapCaiDatSanPhamRepository>();

                List<MT.Data.BO.Phieu_NhapCaiDatSanPham> Phieu_NhapCaiDatSanPhams = grdPhieuXuatCD.GrdDetail.GetAllData<MT.Data.BO.Phieu_NhapCaiDatSanPham>();
                if (Phieu_NhapCaiDatSanPhams == null || Phieu_NhapCaiDatSanPhams.Count == 0)
                {
                    MMessage.ShowWarning("Bạn phải chọn ít nhất 1 phiếu");
                    return;
                }
                Phieu_NhapCaiDatSanPhamRep.SaveApproveOrReject(Phieu_NhapCaiDatSanPhams,
        ...
        private void frmPhieu_NhapCaiDatSanPham_PheDuyet_Shown(object sender, EventArgs e)
        {
            grdPhieuXuatCD.GrdDetail.LoadData(this.Phieu_NhapCaiDatSanPhams);
        }
        #endregion
