...
namespace FormUI
{
    public partial class frmPhieu_XuatTHTH_CT_PhuKienDetail : FormUI.FormUIBase
    {
        private Phieu_XuatTHTH_CT _Phieu_XuatTHTH_CT;
        ...
        public frmPhieu_XuatTHTH_CT_PhuKienDetail(Phieu_XuatTHTH_CT phieu_XuatTHTH_CT)
        {
            InitializeComponent();
            _Phieu_XuatTHTH_CT = phieu_XuatTHTH_CT;
            InitLookup();
            InitGrid();
        }
        ...
        private void InitGrid()
        {
            ...
            grdPhuKienDetail.GrdDetail.TableName = "Phieu_XuatTHTH_CT_PhuKien";
            grdPhuKienDetail.GrdDetail.KeyName = "Id";
            grdPhuKienDetail.GrdDetail.SetField = "phieu_XuatTHTH_CT_PhuKiens";
        ...
        private void frmXuatTHTHCT_PhuKien_Detail_Load(object sender, EventArgs e)
        {
            ...
            CommonFnUI.BinddingValueIntoControl(_Phieu_XuatTHTH_CT, dicControls);
        ...
        {
            _Phieu_XuatTHTH_CT.phieu_XuatTHTH_CT_PhuKiens = grdPhuKienDetail.GrdDetail.GetDataChanges();
            this.Close();
        }

        private void backgroundWorkerLoadChiTietPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            e.Result = DBContext.GetRep<Phieu_XuatTHTH_CTRepository>().GetDetailsByMasterID2("Phieu_XuatTHTH_CT_PhuKien",
                "Phieu_XuatTHTH_CT_PhuKien",
                _Phieu_XuatTHTH_CT.Id);
        }
        ...
        private void backgroundWorkerLoadChiTietPhuKien_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (e.Error == null)
            {
                if (e.Result != null)
                {
                    ...
                    if (_Phieu_XuatTHTH_CT.phieu_XuatTHTH_CT_PhuKiens != null
                        && _Phieu_XuatTHTH_CT.phieu_XuatTHTH_CT_PhuKiens.Count > 0)
                    {
                        foreach (var oldItem in _Phieu_XuatTHTH_CT.phieu_XuatTHTH_CT_PhuKiens)
                        {
                            Phieu_XuatTHTH_CT_PhuKien castOldItem = (Phieu_XuatTHTH_CT_PhuKien)oldItem;
                            ...
                            {
                                Phieu_XuatTHTH_CT_PhuKien castDbItem = (Phieu_XuatTHTH_CT_PhuKien)dbItem;
        ...
        protected void CustomRowCellGridDetail(MGridControl mGridControl, RepositoryItem repository, CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "Phieu_XuatTHTH_CT_PhuKien":
                    if (e.Column.FieldName == "sDM_PhuKien_Id")
                    {
                        ...
                        mRepositoryItemLookUpEdit.DataSource = DBContext.GetRep<MT.Data.Rep.DM_PhuKienRepository>().GetData(typeof(MT.Data.BO.DM_PhuKien),
                         "Id,sMaPhuKien,sTenPhuKien", where: $"sDM_SanPham_Id='{_Phieu_XuatTHTH_CT.sDM_SanPham_Id.Value}'");
                    }
                    break;
            }
        }
        ...
        protected void CustomRowCellValueChangedGridDetail(MGridControl mGridControl, CellValueChangedEventArgs e)
        {
            switch (mGridControl.TableName)
            {
                case "Phieu_XuatTHTH_CT_PhuKien":
                    ...
                    {
                        var phieu_XuatTHTH_CT_PhuKien = mGridControl.GetRecordByRowSelected<Phieu_XuatTHTH_CT_PhuKien>();
                        mGridControl.FirstView.SetRowCellValue(e.RowHandle, "rThanhTien", phieu_XuatTHTH_CT_PhuKien.rSoLuong * phieu_XuatTHTH_CT_PhuKien.rDonGia);
                    }
                    break;
            }
        }
