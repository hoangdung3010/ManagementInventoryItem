...
namespace FormUI
{
    public partial class frmPhieu_XuatBaoHanhSanPham : FormUI.MFormList
    {
        #region"Property"
        ...
        {
            cboiLoaiXuatBaoHanh.ItemEnum.Add(-1, "Tất cả");
            cboiLoaiXuatBaoHanh.DefaultValueEnum = -1;
            drKyBaoCao.SetDefaultValue(MT.Library.Enummation.Period.NamNay);

            drKyBaoCao.Period_Changed = new EventHandler(LoadMasterData);

            cboiLoaiXuatBaoHanh.EnumData = "iLoaiXuatBaoHanh";
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_XuatBaoHanhSanPhamRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            var colMaster = this.gridMaster.AddColumnText("sMa", "Số phiếu", "Số phiếu", 80, isFixWidth: true, fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("sMa_KH", "Căn cứ số", "Căn cứ số", 80, isFixWidth: true);
            this.gridMaster.AddColumnText("dNgayPhieu_Xuat", "Ngày lập phiếu", 80, dataType: DataTypeColumn.DateEdit);
            //this.gridMaster.AddColumnText("sMaPhieu_XuatBaoHanhSanPham", "Mã phiếu xuất","Mã phiếu xuất", 180,isFixWidth:true,fixedStyle:DevExpress.XtraGrid.Columns.FixedStyle.Left);
            ...
            //Sản phẩm
            grdSanPham.TableName = "Phieu_XuatBaoHanhSanPham_CT";
            grdSanPham.ViewName = "View_Phieu_XuatBaoHanhSanPham_CT";
            ...
            grdPhuKienDetail.TableName = "Phieu_XuatBaoHanhSanPham_CT_PhuKien";
            grdPhuKienDetail.ViewName = "View_Phieu_XuatBaoHanhSanPham_CT_PhuKien";
        ...
        private bool CheckPermissionAproveOrReject(MT.Data.iTrangThaiDuyetPNBH iTrangThaiDuyetKHNM)
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatBaoHanhSanPham>();
            ...
            if (iTrangThaiDuyetKHNM == MT.Data.iTrangThaiDuyetPNBH.TuChoiDuyet)
            {
                msg = "Từ chối";
            }
            ...
            foreach (var item in datas)
            {
                ...
                List<string> pHXuatSP_sMas = DBContext.GetRep2<Phieu_XuatBaoHanhSanPhamRepository>().GetPhieuNhapsByPhX(item.Id);
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                ...
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatBaoHanhSanPham>();
                        ...
                        var frmPhieu_XuatBaoHanhSanPham_PheDuyet = new frmPhieu_XuatBaoHanhSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNBH.DongYDuyet, datasApprove);
                        frmPhieu_XuatBaoHanhSanPham_PheDuyet.ShowDialog();
                        frmPhieu_XuatBaoHanhSanPham_PheDuyet.Dispose();
                    }
                    break;
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatBaoHanhSanPham>();
                        ...
                        var frmPhieu_XuatBaoHanhSanPham_TuChoi = new frmPhieu_XuatBaoHanhSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNBH.TuChoiDuyet, datasReject);
                        frmPhieu_XuatBaoHanhSanPham_TuChoi.ShowDialog();
                        frmPhieu_XuatBaoHanhSanPham_TuChoi.Dispose();
                    }
                    break;
            }
        }
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_XuatBaoHanhSanPham_CT")
            {
        ...
        private void LoadMasterData(object sender, EventArgs e)
        {
            try
            {
                ...
                PagingList.SetWhere($@" dNgayPhieu_Xuat BETWEEN '{drKyBaoCao.FromDate.Value.StartDate()}'
                                    ...
                                    AND (iLoai={cboiLoaiXuatBaoHanh.GetValue()} OR {cboiLoaiXuatBaoHanh.GetValue()}<=-1)");
                RefreshData();
            }
            catch (Exception ex)
            {
        ...
        private void frmPhieu_XuatBaoHanhSanPham_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_XuatBaoHanhSanPham_CTRepository>().GetDetailsByMasterID2("View_Phieu_XuatBaoHanhSanPham_CT_PhuKien",
                        "Phieu_XuatBaoHanhSanPham_CT_PhuKien", e.Argument);
            }
            finally
            {
        ...
        private void cboiLoaiXuatBaoHanh_SelectedValueChanged(object sender, EventArgs e)
        {
