...
namespace FormUI
{
    public partial class frmPhieu_XuatSanPham : FormUI.MFormList
    {
        #region"Property"
        ...
        private void InitGrid()
        {
            ...
            grd.ViewName = ((Phieu_XuatSanPhamRepository)ConfigFormDetail.Rep).GetViewPaging();
            ...
            this.gridMaster.AddColumnText("soKHX", "Số kế hoạch xuất", "Số kế hoạch xuất", 120, isFixWidth: true);
            //this.gridMaster.AddColumnText("sMaPhieu_XuatSanPham", "Mã phiếu xuất","Mã phiếu xuất", 180,isFixWidth:true,fixedStyle:DevExpress.XtraGrid.Columns.FixedStyle.Left);
            this.gridMaster.AddColumnText("dNgayPhieu_Xuat", "Ngày phiếu", 100);
            //this.gridMaster.AddColumnText("sKH_XuatSanPham_Id_CanCu", "Kế hoạch xuất", 150,fixedStyle: DevExpress.XtraGrid.Columns.FixedStyle.Left);
            ...
            //Sản phẩm
            grdSanPham.TableName = "Phieu_XuatSanPham_CT";
            grdSanPham.ViewName = "View_Phieu_XuatSanPham_CT";
            ...
            col = grdSanPham.AddColumnText("sSTTSP", "STT sản phẩm", 100);
            ...
            grdPhuKienDetail.TableName = "Phieu_XuatSanPham_CT_PhuKien";
            grdPhuKienDetail.ViewName = "View_Phieu_XuatSanPham_CT_PhuKien";
        ...
        {
            var datas = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatSanPham>();
        ...
        protected override void ProcessItemClick(int tag, object sender)
        {
            ...
            switch (tag)
            {
                ...
                case (int)MCommandName.Approve:
                    ...
                    {
                        var datasApprove = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatSanPham>();
                        ...
                        var frmPhieu_XuatSanPham_PheDuyet = new frmPhieu_XuatSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.DongYDuyet, datasApprove);
                        frmPhieu_XuatSanPham_PheDuyet.ShowDialog();
                        frmPhieu_XuatSanPham_PheDuyet.Dispose();
                    }
                    break;
                ...
                case (int)MCommandName.Reject:
                    ...
                    {
                        var datasReject = gridMaster.GetListRecordByRowsSelected<MT.Data.BO.Phieu_XuatSanPham>();
                        ...
                        var frmPhieu_XuatSanPham_TuChoi = new frmPhieu_XuatSanPham_PheDuyet(this.RefreshData, (int)MT.Data.iTrangThaiDuyetPNM.TuChoiDuyet, datasReject);
                        frmPhieu_XuatSanPham_TuChoi.ShowDialog();
                        frmPhieu_XuatSanPham_TuChoi.Dispose();
                    }
                    break;
            }
        }
        ...
        protected override void CustomLoadFinishDetailByMaster(MGridControl gridControl, IList data)
        {
            ...
            if (gridControl.TableName == "Phieu_XuatSanPham_CT")
            {
        ...
        private void frmPhieu_XuatSanPham_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorkerPhuKien_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                e.Result = DBContext.GetRep<Phieu_XuatSanPham_CTRepository>().GetDetailsByMasterID2("View_Phieu_XuatSanPham_CT_PhuKien",
                        "Phieu_XuatSanPham_CT_PhuKien", e.Argument);
            }
            finally
            {
