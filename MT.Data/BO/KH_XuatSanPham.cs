...
namespace MT.Data.BO
{
   // [ForeignKey("KH_XuatBaoDam", "sKH_XuatBaoDam_Id")]
    public class KH_XuatSanPham : BaseEntity
    {
        #region Instance Properties
        [Key]
        public Guid Id { get; set; }

        public Guid? sKH_BaoDam_Id { get; set; }
        public string sKH_BaoDam_Ten { get; set; }
        public string sSoKHBD { get; set; }
        [Code]
        ...
        public int iDonViThoiGianHieuLuc { get; set; } // NOTEEEEEEEEE
        ...
        [IgnoreLog]
        public IList kH_XuatSanPham_CTs { get; set; }
        ...
        public KH_XuatSanPham()
        {
            this.DetailConfig = new string[1] { "kH_XuatSanPham_CTs" };
        }
    }
