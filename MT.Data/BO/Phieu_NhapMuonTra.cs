...
{
    public class Phieu_NhapMuonTra : BaseEntity
    {
        ...
        public Guid? sPhieu_XuatMuonTra_Id_CanCu { get; set; }
        public string sPhieu_XuatMuonTra_Id_CanCu_Ten { get; set; }
        ...
        //public Guid sMaPhieu_NhapMuonTra { get; set; }
        public string sGhiChu { get; set; }

        public bool? iNhapVeKho { get; set; }
        public bool? bDeleted { get; set; }
        [IgnoreLog]
        public IList phieu_NhapMuonTra_CTs { get; set; }
        ...
        public Phieu_NhapMuonTra()
        {
            this.DetailConfig = new string[1] { "phieu_NhapMuonTra_CTs" };
        }
    }
}