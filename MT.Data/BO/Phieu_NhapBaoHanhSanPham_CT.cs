...
{
    [ForeignKey("Phieu_NhapBaoHanhSanPham", "sPhieu_NhapBaoHanhSanPham_Id")]
    public class Phieu_NhapBaoHanhSanPham_CT : BaseEntity
    {
        ...
        public Guid? sPhieu_NhapBaoHanhSanPham_Id { get; set; }
        public Guid? sPhieu_XuatBaoHanhSanPham_CT_Id { get; set; }
        public Guid? sPhieu_XuatBaoHanhSanPham_Id { get; set; }
        [Code]
        ...
        // Extend
        [IgnoreLog]
        public IList phieu_NhapBaoHanhSanPham_CT_PhuKiens { get; set; }
        #endregion Instance Properties
        public Phieu_NhapBaoHanhSanPham_CT()
        {
            this.DetailConfig = new string[1] { "phieu_NhapBaoHanhSanPham_CT_PhuKiens" };
        }
    }
