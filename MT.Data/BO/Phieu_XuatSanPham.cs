...
{
    public class Phieu_XuatSanPham : BaseEntity
    {
        ...
        public Guid? sKH_XuatSanPham_Id_CanCu { get; set; }
        public string sKH_XuatSanPham_Id_CanCu_Ten { get; set; }
        public string soKHX { get; set; } // Note Phieu_XuatSanPham_CTRepository
        ...
        //public Guid sMaPhieu_XuatSanPham { get; set; }
        public string sGhiChu { get; set; }

        public bool? bDeleted { get; set; }
        [IgnoreLog]
        public IList phieu_XuatSanPham_CTs { get; set; }
        ...
        public Phieu_XuatSanPham()
        {
            this.DetailConfig = new string[1] { "phieu_XuatSanPham_CTs" };
        }
    }
}