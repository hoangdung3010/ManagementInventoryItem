...
{
    [ForeignKey("Phieu_XuatMuonTra", "sPhieu_XuatMuonTra_Id")]
    public class Phieu_XuatMuonTra_CT : BaseEntity
    {
        ...
        public Guid? sPhieu_XuatMuonTra_Id { get; set; } //sPhieu_XuatMuonTra_Id
        public string sPhieu_XuatMuonTra_Id_Ten { get; set; }
        public Guid? sKH_XuatMuonTra_CT_Id { get; set; }  // Note 14.6
        public string sKH_XuatMuonTra_CT_Id_Ten { get; set; }
        public Guid? sKH_XuatMuonTra_Id { get; set; }  // Note 14.6
        ...
        //-------end note---------
        [IgnoreLog]
        public IList phieu_XuatMuonTra_CT_PhuKiens { get; set; }

        public Phieu_XuatMuonTra_CT()
        {
            this.DetailConfig = new string[1] { "phieu_XuatMuonTra_CT_PhuKiens" };
        }
