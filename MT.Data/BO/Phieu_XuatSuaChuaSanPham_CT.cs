...
{
    [ForeignKey("Phieu_XuatSuaChuaSanPham", "sPhieu_XuatSuaChuaSanPham_Id")]
    public class Phieu_XuatSuaChuaSanPham_CT : BaseEntity
    {
        ...
        public Guid? sKH_SuaChuaSanPham_CT_Id { get; set; }
        ...
        [IgnoreLog]
        public IList phieu_XuatSuaChuaSanPham_CT_PhuKiens { get; set; }
        public Phieu_XuatSuaChuaSanPham_CT()
        {
            this.DetailConfig = new string[1] { "phieu_XuatSuaChuaSanPham_CT_PhuKiens" };
        }
