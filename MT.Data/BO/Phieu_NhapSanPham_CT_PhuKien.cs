...
{
    [ForeignKey("Phieu_NhapSanPham_CT", "sPhieu_NhapSanPham_CT_Id")]
    public class Phieu_NhapSanPham_CT_PhuKien : BaseEntity
    {
        #region Instance Properties
        [Key]
        public Guid Id { get; set; }

        public Guid? sPhieu_NhapSanPham_CT_Id { get; set; } //sPhieu_NhapSanPham_Id
