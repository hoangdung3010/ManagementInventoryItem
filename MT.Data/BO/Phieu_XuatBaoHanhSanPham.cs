...
{
    public class Phieu_XuatBaoHanhSanPham : BaseEntity
    {
        ...
        public Guid? sKH_BaoHanhSanPham_Id_CanCu { get; set; }
        ...
        // Extend
        [IgnoreLog]
        public IList phieu_XuatBaoHanhSanPham_CTs { get; set; }
        ...
        public Phieu_XuatBaoHanhSanPham()
        {
            this.DetailConfig = new string[1] { "phieu_XuatBaoHanhSanPham_CTs" };
        }
    }
