...
{
    [ForeignKey("Phieu_NhapSuaChuaSanPham_CT", "sPhieu_NhapSuaChuaSanPham_CT_Id")]
    public class Phieu_NhapSuaChuaSanPham_CT_PhuKien : BaseEntity
    {
        #region Instance Properties
        [Key]
        public Guid Id { get; set; }

        public Guid? sPhieu_NhapSuaChuaSanPham_CT_Id { get; set; }
