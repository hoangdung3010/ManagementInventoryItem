...
{
    [ForeignKey("KH_XuatTHTH", "sKH_XuatTHTH_Id")]
    public class KH_XuatTHTH_CT : BaseEntity
    {
        ...
        public Guid? sKH_XuatTHTH_Id { get; set; } //sKH_XuatTHTH_Id
        ...
        [IgnoreLog]
        public IList kH_XuatTHTH_CT_PhuKiens { get; set; }
        //public IList kH_NhapSanPhamMoi_CT_PhuKiens { get; set; }
        public KH_XuatTHTH_CT()
        {
            this.DetailConfig = new string[1] { "kH_XuatTHTH_CT_PhuKiens" };
        }
