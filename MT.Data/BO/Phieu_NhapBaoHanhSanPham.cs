...
{
    public class Phieu_NhapBaoHanhSanPham : BaseEntity
    {
        ...
        public Guid? sPhieu_XuatBaoHanhSanPham_Id_CanCu { get; set; }
        ...
        // Extend
        [IgnoreLog]
        public IList phieu_NhapBaoHanhSanPham_CTs { get; set; }
        ...
        public Phieu_NhapBaoHanhSanPham()
        {
            this.DetailConfig = new string[1] { "phieu_NhapBaoHanhSanPham_CTs" };
        }
    }
