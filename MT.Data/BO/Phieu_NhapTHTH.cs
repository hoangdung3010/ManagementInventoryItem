...
{
    public class Phieu_NhapTHTH : BaseEntity
    {
        ...
        public Guid? sPhieu_XuatTHTH_Id_CanCu { get; set; }
        public string sPhieu_XuatTHTH_Id_CanCu_Ten { get; set; }
        ...
        //public Guid sMaPhieu_NhapTHTH { get; set; }
        public string sGhiChu { get; set; }

        public bool? iNhapVeKho { get; set; }
        public bool? bDeleted { get; set; }
        [IgnoreLog]
        public IList phieu_NhapTHTH_CTs { get; set; }
        ...
        public Phieu_NhapTHTH()
        {
            this.DetailConfig = new string[1] { "phieu_NhapTHTH_CTs" };
        }
    }
}