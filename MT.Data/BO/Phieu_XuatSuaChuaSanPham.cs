...
{
    public class Phieu_XuatSuaChuaSanPham : BaseEntity
    {
        ...
        public Guid? sKH_SuaChuaSanPham_Id_CanCu { get; set; }
        ...
        // Extend
        [IgnoreLog]
        public IList phieu_XuatSuaChuaSanPham_CTs { get; set; }
        ...
        public Phieu_XuatSuaChuaSanPham()
        {
            this.DetailConfig = new string[1] { "phieu_XuatSuaChuaSanPham_CTs" };
        }
    }
