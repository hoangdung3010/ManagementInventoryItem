...
{
    [ForeignKey("Phieu_NhapBaoHanhSanPham_CT", "sPhieu_NhapBaoHanhSanPham_CT_Id")]
    public class Phieu_NhapBaoHanhSanPham_CT_PhuKien : BaseEntity
    {
        #region Instance Properties
        [Key]
        public Guid Id { get; set; }

        public Guid? sPhieu_NhapBaoHanhSanPham_CT_Id { get; set; }
