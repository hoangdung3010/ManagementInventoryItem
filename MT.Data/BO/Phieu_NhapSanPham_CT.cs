...
{
    [ForeignKey("Phieu_NhapSanPham", "sPhieu_NhapSanPham_Id")]
    public class Phieu_NhapSanPham_CT : BaseEntity
    {
        ...
        public Guid? sPhieu_NhapSanPham_Id { get; set; }
        public string sPhieu_NhapSanPham_Id_Ten { get; set; }
        public Guid? sPhieu_XuatSanPham_CT_Id { get; set; }
        public string sPhieu_XuatSanPham_CT_Id_Ten { get; set; }
        public Guid? sPhieu_XuatSanPham_Id { get; set; }
        ...
        //-------end note---------
        [IgnoreLog]
        public IList phieu_NhapSanPham_CT_PhuKiens { get; set; }

        public Phieu_NhapSanPham_CT()
        {
            this.DetailConfig = new string[1] { "phieu_NhapSanPham_CT_PhuKiens" };
        }
