...
{
    [ForeignKey("Phieu_NhapTHTH", "sPhieu_NhapTHTH_Id")]
    public class Phieu_NhapTHTH_CT : BaseEntity
    {
        ...
        public Guid? sPhieu_NhapTHTH_Id { get; set; }
        public string sPhieu_NhapTHTH_Id_Ten { get; set; }
        public Guid? sPhieu_XuatTHTH_CT_Id { get; set; }
        public string sPhieu_XuatTHTH_CT_Id_Ten { get; set; }
        public Guid? sPhieu_XuatTHTH_Id { get; set; }
        ...
        //-------end note---------
        [IgnoreLog]
        public IList phieu_NhapTHTH_CT_PhuKiens { get; set; }

        public Phieu_NhapTHTH_CT()
        {
            this.DetailConfig = new string[1] { "phieu_NhapTHTH_CT_PhuKiens" };
        }
