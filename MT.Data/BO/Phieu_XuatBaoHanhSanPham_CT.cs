...
{
    [ForeignKey("Phieu_XuatBaoHanhSanPham", "sPhieu_XuatBaoHanhSanPham_Id")]
    public class Phieu_XuatBaoHanhSanPham_CT : BaseEntity
    {
        ...
        public Guid? sKH_BaoHanhSanPham_CT_Id { get; set; }
        ...
        [IgnoreLog]
        public IList phieu_XuatBaoHanhSanPham_CT_PhuKiens { get; set; }
        public Phieu_XuatBaoHanhSanPham_CT()
        {
            this.DetailConfig = new string[1] { "phieu_XuatBaoHanhSanPham_CT_PhuKiens" };
        }
