...
{
    public class Phieu_XuatTHTH : BaseEntity
    {
        ...
        public Guid? sKH_XuatTHTH_Id_CanCu { get; set; }
        public string sKH_XuatTHTH_Id_CanCu_Ten { get; set; }
        public string soKHX { get; set; } // Note Phieu_XuatTHTH_CTRepository
        ...
        //public Guid sMaPhieu_XuatTHTH { get; set; }
        public string sGhiChu { get; set; }

        public bool? bDeleted { get; set; }
        [IgnoreLog]
        public IList phieu_XuatTHTH_CTs { get; set; }
        ...
        public Phieu_XuatTHTH()
        {
            this.DetailConfig = new string[1] { "phieu_XuatTHTH_CTs" };
        }
    }
}