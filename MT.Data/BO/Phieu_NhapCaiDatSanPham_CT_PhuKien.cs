...
{
    [ForeignKey("Phieu_NhapCaiDatSanPham_CT", "sPhieu_NhapCaiDatSanPham_CT_Id")]
    public class Phieu_NhapCaiDatSanPham_CT_PhuKien : BaseEntity
    {
        #region Instance Properties
        [Key]
        public Guid Id { get; set; }

        public Guid? sPhieu_NhapCaiDatSanPham_CT_Id { get; set; }
