...
{
    public class Phieu_NhapSuaChuaSanPham : BaseEntity
    {
        ...
        public Guid? sPhieu_XuatSuaChuaSanPham_Id_CanCu { get; set; }
        ...
        // Extend
        [IgnoreLog]
        public IList phieu_NhapSuaChuaSanPham_CTs { get; set; }
        ...
        public Phieu_NhapSuaChuaSanPham()
        {
            this.DetailConfig = new string[1] { "phieu_NhapSuaChuaSanPham_CTs" };
        }
    }
