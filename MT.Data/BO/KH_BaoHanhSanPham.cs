...
{
    public class KH_BaoHanhSanPham : BaseEntity
    {
        ...
        [IgnoreLog]
        public IList kH_BaoHanhSanPham_CTs { get; set; }
        ...
        #region"Contructors"
        public KH_BaoHanhSanPham()
        {
            this.DetailConfig = new string[1] { "kH_BaoHanhSanPham_CTs" };
        }
        #endregion
    }
