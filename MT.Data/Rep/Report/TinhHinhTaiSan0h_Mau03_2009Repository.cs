...
{
    public class TinhHinhTaiSan0h_Mau03_2009Repository : BaseReportRepository
    {
        public TinhHinhTaiSan0h_Mau03_2009Repository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
