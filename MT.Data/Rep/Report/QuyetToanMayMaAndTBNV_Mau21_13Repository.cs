...
{
    public class QuyetToanMayMaAndTBNV_Mau21_13Repository : BaseReportRepository
    {
        public QuyetToanMayMaAndTBNV_Mau21_13Repository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
