...
{
    public class Print_KH_SuaChuaSanPham_DetailRepository : BaseReportRepository
    {
        public Print_KH_SuaChuaSanPham_DetailRepository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
