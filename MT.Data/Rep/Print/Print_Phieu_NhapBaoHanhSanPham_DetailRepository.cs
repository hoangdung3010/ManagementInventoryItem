...
{
    public class Print_Phieu_NhapBaoHanhSanPham_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_NhapBaoHanhSanPham_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            if (piLoai != null)
            {
                MTControl.DisplayEnum displayEnum = MTControl.MCommon.GetDisplayEnum("iLoaiNhapBaoHanh",
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU NHẬP BẢO HÀNH SẢN PHẨM"
            });
