...
{
    public class Print_Phieu_XuatTHTH_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_XuatTHTH_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            //SubTitle
            var pdNgayPhieu_XuatTHTH = configExcel.ParametersExcel.GetValueOfDictionary("dNgayPhieu_Xuat");
            if (pdNgayPhieu_XuatTHTH != null)
            {
                DateTime dNgayLap = (DateTime)pdNgayPhieu_XuatTHTH.OriginValue;
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU XUẤT THU HỒI, TIÊU HỦY"
            });
