...
{
    public class Print_KH_CaiDatSanPham_DetailRepository : BaseReportRepository
    {
        public Print_KH_CaiDatSanPham_DetailRepository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
