...
{
    public class Print_Phieu_NhapTHTH_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_NhapTHTH_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            if (piLoai != null)
            {
                MTControl.DisplayEnum displayEnum = MTControl.MCommon.GetDisplayEnum("iTCNhapTH",
            ...
            //SubTitle
            var pdNgayPhieu_NhapTHTH = configExcel.ParametersExcel.GetValueOfDictionary("dNgayPhieu_Nhap");
            if (pdNgayPhieu_NhapTHTH != null)
            {
                DateTime dNgayLap = (DateTime)pdNgayPhieu_NhapTHTH.OriginValue;
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU NHẬP THU HỒI, TIÊU HỦY SẢN PHẨM"
            });
