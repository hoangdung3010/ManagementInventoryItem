...
{
    public class Print_Phieu_NhapSuaChuaSanPham_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_NhapSuaChuaSanPham_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            if (piLoai != null)
            {
                MTControl.DisplayEnum displayEnum = MTControl.MCommon.GetDisplayEnum("iLoaiNhapSuaChua",
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU NHẬP SỬA CHỮA SẢN PHẨM"
            });
