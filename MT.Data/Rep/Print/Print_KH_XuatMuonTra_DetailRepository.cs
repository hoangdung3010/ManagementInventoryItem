...
{
    public class Print_KH_XuatMuonTra_DetailRepository : BaseReportRepository
    {
        public Print_KH_XuatMuonTra_DetailRepository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
           ...
           /* var piLoai = configExcel.ParametersExcel.GetValueOfDictionary("iTCXuat");
            ...
            //SubTitle
            var pdNgayKH_XuatMuonTra = configExcel.ParametersExcel.GetValueOfDictionary("dNgayKeHoach");
            if (pdNgayKH_XuatMuonTra != null)
            {
                DateTime dNgayLap =(DateTime)pdNgayKH_XuatMuonTra.OriginValue;
