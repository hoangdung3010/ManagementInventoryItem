...
{
    public class Print_Phieu_NhapSanPham_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_NhapSanPham_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            //SubTitle
            var pdNgayPhieu_NhapSanPham = configExcel.ParametersExcel.GetValueOfDictionary("dNgayPhieu_Nhap");
            if (pdNgayPhieu_NhapSanPham != null)
            {
                DateTime dNgayLap = (DateTime)pdNgayPhieu_NhapSanPham.OriginValue;
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU NHẬP SẢN PHẨM"
            });
