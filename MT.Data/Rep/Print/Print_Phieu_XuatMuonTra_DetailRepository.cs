...
{
    public class Print_Phieu_XuatMuonTra_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_XuatMuonTra_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            if (piLoai != null)
            {
                MTControl.DisplayEnum displayEnum = MTControl.MCommon.GetDisplayEnum("iTCXuat",
            ...
            //SubTitle
            var pdNgayPhieu_XuatMuonTra = configExcel.ParametersExcel.GetValueOfDictionary("dNgayPhieu_Xuat");
            if (pdNgayPhieu_XuatMuonTra != null)
            {
                DateTime dNgayLap = (DateTime)pdNgayPhieu_XuatMuonTra.OriginValue;
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU XUẤT MƯỢN TRẢ SẢN PHẨM"
            });
