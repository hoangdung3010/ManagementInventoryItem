...
{
    public class Print_Phieu_XuatCaiDatSanPham_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_XuatCaiDatSanPham_DetailRepository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            if (piLoai != null)
            {
                MTControl.DisplayEnum displayEnum = MTControl.MCommon.GetDisplayEnum("iTCXuatCĐ",
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU XUẤT CÀI ĐẶT SẢN PHẨM"
            });
