...
{
    public class Print_Phieu_XuatSuaChuaSanPham_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_XuatSuaChuaSanPham_DetailRepository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            if (piLoai != null)
            {
                MTControl.DisplayEnum displayEnum = MTControl.MCommon.GetDisplayEnum("iLoaiXuatSuaChua",
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU XUẤT SỬA CHỮA SẢN PHẨM"
            });
