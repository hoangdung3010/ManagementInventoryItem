...
{
    public class Print_Phieu_XuatSanPham_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_XuatSanPham_DetailRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            //SubTitle
            var pdNgayPhieu_XuatSanPham = configExcel.ParametersExcel.GetValueOfDictionary("dNgayPhieu_Xuat");
            if (pdNgayPhieu_XuatSanPham != null)
            {
                DateTime dNgayLap = (DateTime)pdNgayPhieu_XuatSanPham.OriginValue;
            ...
            {
                Value = "PHỤ LỤC CHI TIẾT PHIẾU XUẤT"
            });
