...
{
    public class Print_Phieu_NhapSanPhamMoi_DetailRepository : BaseReportRepository
    {
        public Print_Phieu_NhapSanPhamMoi_DetailRepository(IUnitOfWork unitOfWork):base(unitOfWork)
        {
        ...
        protected override void CustomInitParameterExcel(ConfigExcel configExcel, XlsFile result, FlexCelReport fr)
        {
            ...
            //SubTitle
            var pdNgayPhieu_NhapSanPhamMoi = configExcel.ParametersExcel.GetValueOfDictionary("dNgayPhieu_NhapSanPhamMoi");
            if (pdNgayPhieu_NhapSanPhamMoi != null)
            {
                DateTime dNgayLap =(DateTime)pdNgayPhieu_NhapSanPhamMoi.OriginValue;
            ...
            {
                Value ="PHỤ LỤC CHI TIẾT PHIẾU NHẬP MỚI"
            });
