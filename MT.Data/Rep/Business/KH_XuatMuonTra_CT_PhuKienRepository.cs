...
{
    public class KH_XuatMuonTra_CT_PhuKienRepository : MT.Data.Rep.BaseRepository<KH_XuatMuonTra_CT_PhuKien>
    {
        #region "Constructor"
        public KH_XuatMuonTra_CT_PhuKienRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
        #endregion
